...
def unpack_stage2():
    ...
    global rpcunpacker, RPCTwinMuxRawToDigi, twinMuxStage2Digis, rpcCPPFRawToDigi, bmtfDigis, omtfStage2Digis, emtfStage2Digis, caloLayer1Digis, caloStage2Digis, gmtStage2Digis, gtStage2Digis,L1TRawToDigi_Stage2    
    ...
    L1TRawToDigi_Stage2 = cms.Sequence(rpcunpacker + RPCTwinMuxRawToDigi + twinMuxStage2Digis * bmtfDigis + rpcCPPFRawToDigi + omtfStage2Digis + emtfStage2Digis + caloLayer1Digis + caloStage2Digis + gmtStage2Digis + gtStage2Digis)
