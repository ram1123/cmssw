...
private:
  ...
  TH1D* h1_ring_Cu_Allbx;  ///<  ;Unpacker; #nHits on chamber > 2 && bunch crossing == 0 for all hits on a chamber
  ...
  TH1D* h1_ring_Ce_Allbx;  ///< ;Emulator; #nHits on chamber > 2 && bunch crossing == 0 for all hits on a chamber.
  ...
  TH1D* h1_SameKey_OnPhi_ring_Cu_Allbx; ///< ; ; bunch crossing ==0 for each hit on a chamber && Hit at same chamber && OnPhi Axis
  ...
  TH1D* h1_SameKey_OnPhi_ring_Ce_Allbx; ///< ; ; bunch crossing ==0 for each hit on a chamber && Hit at same chamber && OnPhi Axis
  ...
  TH1D* h1_SameKey_OffPhi_ring_Cu_Allbx; ///<  ; ; bunch crossing ==0 for each hit on a chamber && Hit at same chamber && OffPhi Axis
  ...
  TH1D* h1_SameKey_OffPhi_ring_Ce_Allbx; ///<  ; ; bunch crossing ==0 for each hit on a chamber && Hit at same chamber && OffPhi Axis
  ...
  TH1D* h1_SameKey_OnTheta_ring_Cu_Allbx; ///< ; ; bunch crossing ==0 for each hit on a chamber && Hit at same chamber && OnTheta Axis
  ...
  TH1D* h1_SameKey_OnTheta_ring_Ce_Allbx; ///< ; ; bunch crossing ==0 for each hit on a chamber && Hit at same chamber && OnTheta Axis
  ...
  TH1D* h1_SameKey_OffTheta_ring_Cu_Allbx; ///<  ; ; bunch crossing ==0 for each hit on a chamber && Hit at same chamber && OffTheta Axis
  ...
  TH1D* h1_SameKey_OffTheta_ring_Ce_Allbx; ///<  ; ; bunch crossing ==0 for each hit on a chamber && Hit at same chamber && OffTheta Axis
