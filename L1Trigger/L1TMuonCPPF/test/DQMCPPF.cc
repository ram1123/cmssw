    ...
    for(auto& cppf_digis2 : *CppfDigis2){
      ...
      if (matches_unpacker_bx == 2) {
         ...
         for (int matches=0; matches<2; matches++) {
            ...
            h1_bxCu_bx_twoHit->Fill(ar_bxCu_bx[matches]);
            h1_phiIntCe_bx_twoHit->Fill(ar_phiIntCe_bx[matches]);
            h1_phiIntCu_bx_twoHit->Fill(ar_phiIntCu_bx[matches]);
            h1_thetaIntCu_bx_twoHit->Fill(ar_thetaIntCu_bx[matches]);
            h1_thetaIntCe_bx_twoHit->Fill(ar_thetaIntCe_bx[matches]);
            h1_thetaGlobalCe_bx_twoHit->Fill(ar_thetaGlobalCe_bx[matches]);
            h1_thetaGlobalCu_bx_twoHit->Fill(ar_thetaGlobalCu_bx[matches]);
            h1_phiGlobalCe_bx_twoHit->Fill(ar_phiGlobalCe_bx[matches]);
            h1_phiGlobalCu_bx_twoHit->Fill(ar_phiGlobalCu_bx[matches]);
            h2_bx_emu_unpack_bx_twoHit->Fill(ar_bxCe_bx[matches], ar_bxCu_bx[matches]);
            h2_phiInt_emu_unpack_bx_twoHit->Fill(ar_phiIntCe_bx[matches], ar_phiIntCu_bx[matches]);
            h2_phiGlobal_emu_unpack_bx_twoHit->Fill(ar_phiGlobalCe_bx[matches], ar_phiGlobalCu_bx[matches]);
            h2_thetaInt_emu_unpack_bx_twoHit->Fill(ar_thetaIntCe_bx[matches], ar_thetaIntCu_bx[matches]);
            h2_thetaGlobal_emu_unpack_bx_twoHit->Fill(ar_thetaGlobalCe_bx[matches], ar_thetaGlobalCu_bx[matches]);
            h2_chamberID_emu_unpack_bx_twoHit->Fill(ar_chamberIDCe_bx[matches], ar_chamberIDCu_bx[matches]);
            h2_chamberID_vs_roll_emu_bx_twoHit->Fill(ar_chamberIDCe_bx[matches], ar_rollCe_bx[matches]);
            ...
            if (onphi) {
               ...
               h1_bxCe_bx_twoHit_OffPhi->Fill(ar_bxCe_bx[matches]);
               h1_bxCu_bx_twoHit_OffPhi->Fill(ar_bxCu_bx[matches]);
               h1_phiIntCe_bx_twoHit_OffPhi->Fill(ar_phiIntCe_bx[matches]);
               h1_phiIntCu_bx_twoHit_OffPhi->Fill(ar_phiIntCu_bx[matches]);
               h1_thetaIntCu_bx_twoHit_OffPhi->Fill(ar_thetaIntCu_bx[matches]);
               h1_thetaIntCe_bx_twoHit_OffPhi->Fill(ar_thetaIntCe_bx[matches]);
               h1_thetaGlobalCe_bx_twoHit_OffPhi->Fill(ar_thetaGlobalCe_bx[matches]);
               h1_thetaGlobalCu_bx_twoHit_OffPhi->Fill(ar_thetaGlobalCu_bx[matches]);
               h1_phiGlobalCe_bx_twoHit_OffPhi->Fill(ar_phiGlobalCe_bx[matches]);
               h1_phiGlobalCu_bx_twoHit_OffPhi->Fill(ar_phiGlobalCu_bx[matches]);
               h2_bx_emu_unpack_bx_twoHit_OffPhi->Fill(ar_bxCe_bx[matches], ar_bxCu_bx[matches]);
               h2_phiInt_emu_unpack_bx_twoHit_OffPhi->Fill(ar_phiIntCe_bx[matches], ar_phiIntCu_bx[matches]);
               h2_phiGlobal_emu_unpack_bx_twoHit_OffPhi->Fill(ar_phiGlobalCe_bx[matches], ar_phiGlobalCu_bx[matches]);
               h2_thetaInt_emu_unpack_bx_twoHit_OffPhi->Fill(ar_thetaIntCe_bx[matches], ar_thetaIntCu_bx[matches]);
               h2_thetaGlobal_emu_unpack_bx_twoHit_OffPhi->Fill(ar_thetaGlobalCe_bx[matches], ar_thetaGlobalCu_bx[matches]);
               h2_chamberID_emu_unpack_bx_twoHit_OffPhi->Fill(ar_chamberIDCe_bx[matches], ar_chamberIDCu_bx[matches]);
               h2_chamberID_vs_roll_emu_bx_twoHit_OffPhi->Fill(ar_chamberIDCe_bx[matches], ar_rollCe_bx[matches]);
               h2_chamberID_vs_roll_unpack_bx_twoHit_OffPhi->Fill(ar_chamberIDCu_bx[matches], ar_rollCu_bx[matches]);
               h2_occupancy_unpacker_bx_twoHit_OffPhi->Fill(ar_emtfSubsectorCu_bx[matches], ar_fillOccupancyCu_bx[matches]);
            ...
            if (ar_thetaIntCe_bx[matches] == ar_thetaIntCu_bx[matches]) {
               ...
               h1_bxCe_bx_twoHit_OffTheta->Fill(ar_bxCe_bx[matches]);
               h1_bxCu_bx_twoHit_OffTheta->Fill(ar_bxCu_bx[matches]);
               h1_phiIntCe_bx_twoHit_OffTheta->Fill(ar_phiIntCe_bx[matches]);
               h1_phiIntCu_bx_twoHit_OffTheta->Fill(ar_phiIntCu_bx[matches]);
               h1_thetaIntCu_bx_twoHit_OffTheta->Fill(ar_thetaIntCu_bx[matches]);
               h1_thetaIntCe_bx_twoHit_OffTheta->Fill(ar_thetaIntCe_bx[matches]);
               h1_thetaGlobalCe_bx_twoHit_OffTheta->Fill(ar_thetaGlobalCe_bx[matches]);
               h1_thetaGlobalCu_bx_twoHit_OffTheta->Fill(ar_thetaGlobalCu_bx[matches]);
               h1_phiGlobalCe_bx_twoHit_OffTheta->Fill(ar_phiGlobalCe_bx[matches]);
               h1_phiGlobalCu_bx_twoHit_OffTheta->Fill(ar_phiGlobalCu_bx[matches]);
               h2_bx_emu_unpack_bx_twoHit_OffTheta->Fill(ar_bxCe_bx[matches], ar_bxCu_bx[matches]);
               h2_phiInt_emu_unpack_bx_twoHit_OffTheta->Fill(ar_phiIntCe_bx[matches], ar_phiIntCu_bx[matches]);
               h2_phiGlobal_emu_unpack_bx_twoHit_OffTheta->Fill(ar_phiGlobalCe_bx[matches], ar_phiGlobalCu_bx[matches]);
               h2_thetaInt_emu_unpack_bx_twoHit_OffTheta->Fill(ar_thetaIntCe_bx[matches], ar_thetaIntCu_bx[matches]);
               h2_thetaGlobal_emu_unpack_bx_twoHit_OffTheta->Fill(ar_thetaGlobalCe_bx[matches], ar_thetaGlobalCu_bx[matches]);
               h2_chamberID_emu_unpack_bx_twoHit_OffTheta->Fill(ar_chamberIDCe_bx[matches], ar_chamberIDCu_bx[matches]);
               h2_chamberID_vs_roll_emu_bx_twoHit_OffTheta->Fill(ar_chamberIDCe_bx[matches], ar_rollCe_bx[matches]);
               h2_chamberID_vs_roll_unpack_bx_twoHit_OffTheta->Fill(ar_chamberIDCu_bx[matches], ar_rollCu_bx[matches]);
               h2_occupancy_unpacker_bx_twoHit_OffTheta->Fill(ar_emtfSubsectorCu_bx[matches], ar_fillOccupancyCu_bx[matches]);
               h2_occupancy_emulator_bx_twoHit_OffTheta->Fill(ar_emtfSubsectorCe_bx[matches], ar_fillOccupancyCe_bx[matches]);
            }
...
void DQM_CPPF::beginJob(){
  ...
  h1_cluster_sizeCe_bx_twoHit = fs->make<TH1D>("h1_cluster_sizeCe_bx_twoHit", "Cluster size of emulator with same BX", 10, 0., 10.);
  h1_cluster_sizeCe_bx_twoHit_OnTheta = fs->make<TH1D>("h1_cluster_sizeCe_bx_twoHit_OnTheta", "Cluster size of emulator with same BX", 10, 0., 10.);
  h1_cluster_sizeCe_bx_twoHit_OffTheta = fs->make<TH1D>("h1_cluster_sizeCe_bx_twoHit_OffTheta", "Cluster size of emulator with same BX", 10, 0., 10.);
  h1_cluster_sizeCe_bx_twoHit_OnPhi = fs->make<TH1D>("h1_cluster_sizeCe_bx_twoHit_OnPhi", "Cluster size of emulator with same BX", 10, 0., 10.);
  h1_cluster_sizeCe_bx_twoHit_OffPhi = fs->make<TH1D>("h1_cluster_sizeCe_bx_twoHit_OffPhi", "Cluster size of emulator with same BX", 10, 0., 10.);
  ...
  h1_cluster_sizeCu_bx_twoHit = fs->make<TH1D>("h1_cluster_sizeCu_bx_twoHit", "Cluster size of emulator with same BX", 10, 0., 10.);
  h1_cluster_sizeCu_bx_twoHit_OnTheta = fs->make<TH1D>("h1_cluster_sizeCu_bx_twoHit_OnTheta", "Cluster size of emulator with same BX", 10, 0., 10.);
  h1_cluster_sizeCu_bx_twoHit_OffTheta = fs->make<TH1D>("h1_cluster_sizeCu_bx_twoHit_OffTheta", "Cluster size of emulator with same BX", 10, 0., 10.);
  h1_cluster_sizeCu_bx_twoHit_OnPhi = fs->make<TH1D>("h1_cluster_sizeCu_bx_twoHit_OnPhi", "Cluster size of emulator with same BX", 10, 0., 10.);
  h1_cluster_sizeCu_bx_twoHit_OffPhi = fs->make<TH1D>("h1_cluster_sizeCu_bx_twoHit_OffPhi", "Cluster size of emulator with same BX", 10, 0., 10.);
  ...
  h1_bxCe_bx_twoHit = fs->make<TH1D>("h1_bxCe_bx_twoHit", "h1_bxCe_bx", 8, -4., 4.);
  h1_bxCe_bx_twoHit_OnTheta = fs->make<TH1D>("h1_bxCe_bx_twoHit_OnTheta", "h1_bxCe_bx", 8, -4., 4.);
  h1_bxCe_bx_twoHit_OffTheta = fs->make<TH1D>("h1_bxCe_bx_twoHit_OffTheta", "h1_bxCe_bx", 8, -4., 4.);
  h1_bxCe_bx_twoHit_OnPhi = fs->make<TH1D>("h1_bxCe_bx_twoHit_OnPhi", "h1_bxCe_bx", 8, -4., 4.);
  h1_bxCe_bx_twoHit_OffPhi = fs->make<TH1D>("h1_bxCe_bx_twoHit_OffPhi", "h1_bxCe_bx", 8, -4., 4.);
  ...
  h1_bxCu_bx_twoHit = fs->make<TH1D>("h1_bxCu_bx_twoHit", "h1_bxCu_bx", 8, -4., 4.);
  h1_bxCu_bx_twoHit_OnTheta = fs->make<TH1D>("h1_bxCu_bx_twoHit_OnTheta", "h1_bxCu_bx", 8, -4., 4.);
  h1_bxCu_bx_twoHit_OffTheta = fs->make<TH1D>("h1_bxCu_bx_twoHit_OffTheta", "h1_bxCu_bx", 8, -4., 4.);
  h1_bxCu_bx_twoHit_OnPhi = fs->make<TH1D>("h1_bxCu_bx_twoHit_OnPhi", "h1_bxCu_bx", 8, -4., 4.);
  h1_bxCu_bx_twoHit_OffPhi = fs->make<TH1D>("h1_bxCu_bx_twoHit_OffPhi", "h1_bxCu_bx", 8, -4., 4.);
  ...
  h1_phiIntCe_bx_twoHit = fs->make<TH1D>("h1_phiIntCe_bx_twoHit", "h1_phiIntCe_bx", 124, 0., 1240.);
  h1_phiIntCe_bx_twoHit_OnTheta = fs->make<TH1D>("h1_phiIntCe_bx_twoHit_OnTheta", "h1_phiIntCe_bx", 124, 0., 1240.);
  h1_phiIntCe_bx_twoHit_OffTheta = fs->make<TH1D>("h1_phiIntCe_bx_twoHit_OffTheta", "h1_phiIntCe_bx", 124, 0., 1240.);
  h1_phiIntCe_bx_twoHit_OnPhi = fs->make<TH1D>("h1_phiIntCe_bx_twoHit_OnPhi", "h1_phiIntCe_bx", 124, 0., 1240.);
  h1_phiIntCe_bx_twoHit_OffPhi = fs->make<TH1D>("h1_phiIntCe_bx_twoHit_OffPhi", "h1_phiIntCe_bx", 124, 0., 1240.);
  ...
  h1_phiIntCu_bx_twoHit = fs->make<TH1D>("h1_phiIntCu_bx_twoHit", "h1_phiIntCu_bx", 124, 0., 1240.);
  h1_phiIntCu_bx_twoHit_OnTheta = fs->make<TH1D>("h1_phiIntCu_bx_twoHit_OnTheta", "h1_phiIntCu_bx", 124, 0., 1240.);
  h1_phiIntCu_bx_twoHit_OffTheta = fs->make<TH1D>("h1_phiIntCu_bx_twoHit_OffTheta", "h1_phiIntCu_bx", 124, 0., 1240.);
  h1_phiIntCu_bx_twoHit_OnPhi = fs->make<TH1D>("h1_phiIntCu_bx_twoHit_OnPhi", "h1_phiIntCu_bx", 124, 0., 1240.);
  h1_phiIntCu_bx_twoHit_OffPhi = fs->make<TH1D>("h1_phiIntCu_bx_twoHit_OffPhi", "h1_phiIntCu_bx", 124, 0., 1240.);
  ...
  h1_thetaIntCu_bx_twoHit = fs->make<TH1D>("h1_thetaIntCu_bx_twoHit", "h1_thetaIntCu_bx", 32, 0., 32.);
  h1_thetaIntCu_bx_twoHit_OnTheta = fs->make<TH1D>("h1_thetaIntCu_bx_twoHit_OnTheta", "h1_thetaIntCu_bx", 32, 0., 32.);
  h1_thetaIntCu_bx_twoHit_OffTheta = fs->make<TH1D>("h1_thetaIntCu_bx_twoHit_OffTheta", "h1_thetaIntCu_bx", 32, 0., 32.);
  h1_thetaIntCu_bx_twoHit_OnPhi = fs->make<TH1D>("h1_thetaIntCu_bx_twoHit_OnPhi", "h1_thetaIntCu_bx", 32, 0., 32.);
  h1_thetaIntCu_bx_twoHit_OffPhi = fs->make<TH1D>("h1_thetaIntCu_bx_twoHit_OffPhi", "h1_thetaIntCu_bx", 32, 0., 32.);
  ...
  h1_thetaIntCe_bx_twoHit = fs->make<TH1D>("h1_thetaIntCe_bx_twoHit", "h1_thetaIntCe_bx", 32, 0., 32.);
  h1_thetaIntCe_bx_twoHit_OnTheta = fs->make<TH1D>("h1_thetaIntCe_bx_twoHit_OnTheta", "h1_thetaIntCe_bx", 32, 0., 32.);
  h1_thetaIntCe_bx_twoHit_OffTheta = fs->make<TH1D>("h1_thetaIntCe_bx_twoHit_OffTheta", "h1_thetaIntCe_bx", 32, 0., 32.);
  h1_thetaIntCe_bx_twoHit_OnPhi = fs->make<TH1D>("h1_thetaIntCe_bx_twoHit_OnPhi", "h1_thetaIntCe_bx", 32, 0., 32.);
  h1_thetaIntCe_bx_twoHit_OffPhi = fs->make<TH1D>("h1_thetaIntCe_bx_twoHit_OffPhi", "h1_thetaIntCe_bx", 32, 0., 32.);
  ...
  h1_thetaGlobalCe_bx_twoHit = fs->make<TH1D>("h1_thetaGlobalCe_bx_twoHit", "h1_thetaGlobalCe_bx", 180,0.,180.);
  h1_thetaGlobalCe_bx_twoHit_OnTheta = fs->make<TH1D>("h1_thetaGlobalCe_bx_twoHit_OnTheta", "h1_thetaGlobalCe_bx", 180,0.,180.);
  h1_thetaGlobalCe_bx_twoHit_OffTheta = fs->make<TH1D>("h1_thetaGlobalCe_bx_twoHit_OffTheta", "h1_thetaGlobalCe_bx", 180,0.,180.);
  h1_thetaGlobalCe_bx_twoHit_OnPhi = fs->make<TH1D>("h1_thetaGlobalCe_bx_twoHit_OnPhi", "h1_thetaGlobalCe_bx", 180,0.,180.);
  h1_thetaGlobalCe_bx_twoHit_OffPhi = fs->make<TH1D>("h1_thetaGlobalCe_bx_twoHit_OffPhi", "h1_thetaGlobalCe_bx", 180,0.,180.);
  ...
  h1_thetaGlobalCu_bx_twoHit = fs->make<TH1D>("h1_thetaGlobalCu_bx_twoHit", "h1_thetaGlobalCu_bx", 180,0.,180.);
  h1_thetaGlobalCu_bx_twoHit_OnTheta = fs->make<TH1D>("h1_thetaGlobalCu_bx_twoHit_OnTheta", "h1_thetaGlobalCu_bx", 180,0.,180.);
  h1_thetaGlobalCu_bx_twoHit_OffTheta = fs->make<TH1D>("h1_thetaGlobalCu_bx_twoHit_OffTheta", "h1_thetaGlobalCu_bx", 180,0.,180.);
  h1_thetaGlobalCu_bx_twoHit_OnPhi = fs->make<TH1D>("h1_thetaGlobalCu_bx_twoHit_OnPhi", "h1_thetaGlobalCu_bx", 180,0.,180.);
  h1_thetaGlobalCu_bx_twoHit_OffPhi = fs->make<TH1D>("h1_thetaGlobalCu_bx_twoHit_OffPhi", "h1_thetaGlobalCu_bx", 180,0.,180.);
  ...
  h1_phiGlobalCe_bx_twoHit = fs->make<TH1D>("h1_phiGlobalCe_bx_twoHit", "h1_phiGlobalCe_bx", 360,-180.,180);
  h1_phiGlobalCe_bx_twoHit_OnTheta = fs->make<TH1D>("h1_phiGlobalCe_bx_twoHit_OnTheta", "h1_phiGlobalCe_bx", 360,-180.,180);
  h1_phiGlobalCe_bx_twoHit_OffTheta = fs->make<TH1D>("h1_phiGlobalCe_bx_twoHit_OffTheta", "h1_phiGlobalCe_bx", 360,-180.,180);
  h1_phiGlobalCe_bx_twoHit_OnPhi = fs->make<TH1D>("h1_phiGlobalCe_bx_twoHit_OnPhi", "h1_phiGlobalCe_bx", 360,-180.,180);
  h1_phiGlobalCe_bx_twoHit_OffPhi = fs->make<TH1D>("h1_phiGlobalCe_bx_twoHit_OffPhi", "h1_phiGlobalCe_bx", 360,-180.,180);
  ...
  h1_phiGlobalCu_bx_twoHit = fs->make<TH1D>("h1_phiGlobalCu_bx_twoHit", "h1_phiGlobalCu_bx", 360,-180.,180);
  h1_phiGlobalCu_bx_twoHit_OnTheta = fs->make<TH1D>("h1_phiGlobalCu_bx_twoHit_OnTheta", "h1_phiGlobalCu_bx", 360,-180.,180);
  h1_phiGlobalCu_bx_twoHit_OffTheta = fs->make<TH1D>("h1_phiGlobalCu_bx_twoHit_OffTheta", "h1_phiGlobalCu_bx", 360,-180.,180);
  h1_phiGlobalCu_bx_twoHit_OnPhi = fs->make<TH1D>("h1_phiGlobalCu_bx_twoHit_OnPhi", "h1_phiGlobalCu_bx", 360,-180.,180);
  h1_phiGlobalCu_bx_twoHit_OffPhi = fs->make<TH1D>("h1_phiGlobalCu_bx_twoHit_OffPhi", "h1_phiGlobalCu_bx", 360,-180.,180);
  ...
  h2_bx_emu_unpack_bx_twoHit = fs->make<TH2D>("h2_bx_emu_unpack_bx_twoHit", "h2_bx_emu_unpack_bx", 8, -4., 4.,8, -4., 4.);
  h2_bx_emu_unpack_bx_twoHit_OnTheta = fs->make<TH2D>("h2_bx_emu_unpack_bx_twoHit_OnTheta", "h2_bx_emu_unpack_bx", 8, -4., 4.,8, -4., 4.);
  h2_bx_emu_unpack_bx_twoHit_OffTheta = fs->make<TH2D>("h2_bx_emu_unpack_bx_twoHit_OffTheta", "h2_bx_emu_unpack_bx", 8, -4., 4.,8, -4., 4.);
  h2_bx_emu_unpack_bx_twoHit_OnPhi = fs->make<TH2D>("h2_bx_emu_unpack_bx_twoHit_OnPhi", "h2_bx_emu_unpack_bx", 8, -4., 4.,8, -4., 4.);
  h2_bx_emu_unpack_bx_twoHit_OffPhi = fs->make<TH2D>("h2_bx_emu_unpack_bx_twoHit_OffPhi", "h2_bx_emu_unpack_bx", 8, -4., 4.,8, -4., 4.);
  ...
  h2_phiInt_emu_unpack_bx_twoHit = fs->make<TH2D>("h2_phiInt_emu_unpack_bx_twoHit", "h2_phiInt_emu_unpack_bx", 124, 0., 1240.,124, 0., 1240.);
  h2_phiInt_emu_unpack_bx_twoHit_OnTheta = fs->make<TH2D>("h2_phiInt_emu_unpack_bx_twoHit_OnTheta", "h2_phiInt_emu_unpack_bx", 124, 0., 1240.,124, 0., 1240.);
  h2_phiInt_emu_unpack_bx_twoHit_OffTheta = fs->make<TH2D>("h2_phiInt_emu_unpack_bx_twoHit_OffTheta", "h2_phiInt_emu_unpack_bx", 124, 0., 1240.,124, 0., 1240.);
  h2_phiInt_emu_unpack_bx_twoHit_OnPhi = fs->make<TH2D>("h2_phiInt_emu_unpack_bx_twoHit_OnPhi", "h2_phiInt_emu_unpack_bx", 124, 0., 1240.,124, 0., 1240.);
  h2_phiInt_emu_unpack_bx_twoHit_OffPhi = fs->make<TH2D>("h2_phiInt_emu_unpack_bx_twoHit_OffPhi", "h2_phiInt_emu_unpack_bx", 124, 0., 1240.,124, 0., 1240.);
  ...
  h2_phiGlobal_emu_unpack_bx_twoHit = fs->make<TH2D>("h2_phiGlobal_emu_unpack_bx_twoHit", "h2_phiGlobal_emu_unpack_bx", 360,-180.,180, 360,-180.,180);
  h2_phiGlobal_emu_unpack_bx_twoHit_OnTheta = fs->make<TH2D>("h2_phiGlobal_emu_unpack_bx_twoHit_OnTheta", "h2_phiGlobal_emu_unpack_bx", 360,-180.,180, 360,-180.,180);
  h2_phiGlobal_emu_unpack_bx_twoHit_OffTheta = fs->make<TH2D>("h2_phiGlobal_emu_unpack_bx_twoHit_OffTheta", "h2_phiGlobal_emu_unpack_bx", 360,-180.,180, 360,-180.,180);
  h2_phiGlobal_emu_unpack_bx_twoHit_OnPhi = fs->make<TH2D>("h2_phiGlobal_emu_unpack_bx_twoHit_OnPhi", "h2_phiGlobal_emu_unpack_bx", 360,-180.,180, 360,-180.,180);
  h2_phiGlobal_emu_unpack_bx_twoHit_OffPhi = fs->make<TH2D>("h2_phiGlobal_emu_unpack_bx_twoHit_OffPhi", "h2_phiGlobal_emu_unpack_bx", 360,-180.,180, 360,-180.,180);
  ...
  h2_thetaInt_emu_unpack_bx_twoHit = fs->make<TH2D>("h2_thetaInt_emu_unpack_bx_twoHit", "h2_thetaInt_emu_unpack_bx", 32, 0., 32., 32, 0., 32.);
  h2_thetaInt_emu_unpack_bx_twoHit_OnTheta = fs->make<TH2D>("h2_thetaInt_emu_unpack_bx_twoHit_OnTheta", "h2_thetaInt_emu_unpack_bx", 32, 0., 32., 32, 0., 32.);
  h2_thetaInt_emu_unpack_bx_twoHit_OffTheta = fs->make<TH2D>("h2_thetaInt_emu_unpack_bx_twoHit_OffTheta", "h2_thetaInt_emu_unpack_bx", 32, 0., 32., 32, 0., 32.);
  h2_thetaInt_emu_unpack_bx_twoHit_OnPhi = fs->make<TH2D>("h2_thetaInt_emu_unpack_bx_twoHit_OnPhi", "h2_thetaInt_emu_unpack_bx", 32, 0., 32., 32, 0., 32.);
  h2_thetaInt_emu_unpack_bx_twoHit_OffPhi = fs->make<TH2D>("h2_thetaInt_emu_unpack_bx_twoHit_OffPhi", "h2_thetaInt_emu_unpack_bx", 32, 0., 32., 32, 0., 32.);
  ...
  h2_thetaGlobal_emu_unpack_bx_twoHit = fs->make<TH2D>("h2_thetaGlobal_emu_unpack_bx_twoHit", "h2_thetaGlobal_emu_unpack_bx", 360,-180.,180, 360,-180.,180);
  h2_thetaGlobal_emu_unpack_bx_twoHit_OnTheta = fs->make<TH2D>("h2_thetaGlobal_emu_unpack_bx_twoHit_OnTheta", "h2_thetaGlobal_emu_unpack_bx", 360,-180.,180, 360,-180.,180);
  h2_thetaGlobal_emu_unpack_bx_twoHit_OffTheta = fs->make<TH2D>("h2_thetaGlobal_emu_unpack_bx_twoHit_OffTheta", "h2_thetaGlobal_emu_unpack_bx", 360,-180.,180, 360,-180.,180);
  h2_thetaGlobal_emu_unpack_bx_twoHit_OnPhi = fs->make<TH2D>("h2_thetaGlobal_emu_unpack_bx_twoHit_OnPhi", "h2_thetaGlobal_emu_unpack_bx", 360,-180.,180, 360,-180.,180);
  h2_thetaGlobal_emu_unpack_bx_twoHit_OffPhi = fs->make<TH2D>("h2_thetaGlobal_emu_unpack_bx_twoHit_OffPhi", "h2_thetaGlobal_emu_unpack_bx", 360,-180.,180, 360,-180.,180);
  ...
  h2_chamberID_emu_unpack_bx_twoHit = fs->make<TH2D>("h2_chamberID_emu_unpack_bx_twoHit", "h2_chamberID_emu_unpack_bx", 36, 1, 37, 36, 1, 37);
  h2_chamberID_emu_unpack_bx_twoHit_OnTheta = fs->make<TH2D>("h2_chamberID_emu_unpack_bx_twoHit_OnTheta", "h2_chamberID_emu_unpack_bx", 36, 1, 37, 36, 1, 37);
  h2_chamberID_emu_unpack_bx_twoHit_OffTheta = fs->make<TH2D>("h2_chamberID_emu_unpack_bx_twoHit_OffTheta", "h2_chamberID_emu_unpack_bx", 36, 1, 37, 36, 1, 37);
  h2_chamberID_emu_unpack_bx_twoHit_OnPhi = fs->make<TH2D>("h2_chamberID_emu_unpack_bx_twoHit_OnPhi", "h2_chamberID_emu_unpack_bx", 36, 1, 37, 36, 1, 37);
  h2_chamberID_emu_unpack_bx_twoHit_OffPhi = fs->make<TH2D>("h2_chamberID_emu_unpack_bx_twoHit_OffPhi", "h2_chamberID_emu_unpack_bx", 36, 1, 37, 36, 1, 37);
  ...
  h2_chamberID_vs_roll_emu_bx_twoHit = fs->make<TH2D>("h2_chamberID_vs_roll_emu_bx_twoHit", "h2_chamberID_vs_roll_emu_bx", 36, 1, 37, 4, 0, 4);
  h2_chamberID_vs_roll_emu_bx_twoHit_OnTheta = fs->make<TH2D>("h2_chamberID_vs_roll_emu_bx_twoHit_OnTheta", "h2_chamberID_vs_roll_emu_bx", 36, 1, 37, 4, 0, 4);
  h2_chamberID_vs_roll_emu_bx_twoHit_OffTheta = fs->make<TH2D>("h2_chamberID_vs_roll_emu_bx_twoHit_OffTheta", "h2_chamberID_vs_roll_emu_bx", 36, 1, 37, 4, 0, 4);
  h2_chamberID_vs_roll_emu_bx_twoHit_OnPhi = fs->make<TH2D>("h2_chamberID_vs_roll_emu_bx_twoHit_OnPhi", "h2_chamberID_vs_roll_emu_bx", 36, 1, 37, 4, 0, 4);
  h2_chamberID_vs_roll_emu_bx_twoHit_OffPhi = fs->make<TH2D>("h2_chamberID_vs_roll_emu_bx_twoHit_OffPhi", "h2_chamberID_vs_roll_emu_bx", 36, 1, 37, 4, 0, 4);
  ...
  h2_chamberID_vs_roll_unpack_bx_twoHit = fs->make<TH2D>("h2_chamberID_vs_roll_unpack_bx_twoHit", "h2_chamberID_vs_roll_unpack_bx", 36, 1, 37, 4, 0, 4);
  h2_chamberID_vs_roll_unpack_bx_twoHit_OnTheta = fs->make<TH2D>("h2_chamberID_vs_roll_unpack_bx_twoHit_OnTheta", "h2_chamberID_vs_roll_unpack_bx", 36, 1, 37, 4, 0, 4);
  h2_chamberID_vs_roll_unpack_bx_twoHit_OffTheta = fs->make<TH2D>("h2_chamberID_vs_roll_unpack_bx_twoHit_OffTheta", "h2_chamberID_vs_roll_unpack_bx", 36, 1, 37, 4, 0, 4);
  h2_chamberID_vs_roll_unpack_bx_twoHit_OnPhi = fs->make<TH2D>("h2_chamberID_vs_roll_unpack_bx_twoHit_OnPhi", "h2_chamberID_vs_roll_unpack_bx", 36, 1, 37, 4, 0, 4);
  h2_chamberID_vs_roll_unpack_bx_twoHit_OffPhi = fs->make<TH2D>("h2_chamberID_vs_roll_unpack_bx_twoHit_OffPhi", "h2_chamberID_vs_roll_unpack_bx", 36, 1, 37, 4, 0, 4);
  ...
  h2_occupancy_unpacker_bx_twoHit = fs->make<TH2D>("h2_occupancy_unpacker_bx_twoHit", "h2_occupancy_unpacker_bx", 36, 1, 37, 12, 1, 13);
  h2_occupancy_unpacker_bx_twoHit_OnTheta = fs->make<TH2D>("h2_occupancy_unpacker_bx_twoHit_OnTheta", "h2_occupancy_unpacker_bx", 36, 1, 37, 12, 1, 13);
  h2_occupancy_unpacker_bx_twoHit_OffTheta = fs->make<TH2D>("h2_occupancy_unpacker_bx_twoHit_OffTheta", "h2_occupancy_unpacker_bx", 36, 1, 37, 12, 1, 13);
  h2_occupancy_unpacker_bx_twoHit_OnPhi = fs->make<TH2D>("h2_occupancy_unpacker_bx_twoHit_OnPhi", "h2_occupancy_unpacker_bx", 36, 1, 37, 12, 1, 13);
  h2_occupancy_unpacker_bx_twoHit_OffPhi = fs->make<TH2D>("h2_occupancy_unpacker_bx_twoHit_OffPhi", "h2_occupancy_unpacker_bx", 36, 1, 37, 12, 1, 13);
  ...
  h2_occupancy_emulator_bx_twoHit = fs->make<TH2D>("h2_occupancy_emulator_bx_twoHit", "h2_occupancy_emulator_bx", 36, 1, 37, 12, 1, 13);
  h2_occupancy_emulator_bx_twoHit_OnTheta = fs->make<TH2D>("h2_occupancy_emulator_bx_twoHit_OnTheta", "h2_occupancy_emulator_bx", 36, 1, 37, 12, 1, 13);
  h2_occupancy_emulator_bx_twoHit_OffTheta = fs->make<TH2D>("h2_occupancy_emulator_bx_twoHit_OffTheta", "h2_occupancy_emulator_bx", 36, 1, 37, 12, 1, 13);
  h2_occupancy_emulator_bx_twoHit_OnPhi = fs->make<TH2D>("h2_occupancy_emulator_bx_twoHit_OnPhi", "h2_occupancy_emulator_bx", 36, 1, 37, 12, 1, 13);
  h2_occupancy_emulator_bx_twoHit_OffPhi = fs->make<TH2D>("h2_occupancy_emulator_bx_twoHit_OffPhi", "h2_occupancy_emulator_bx", 36, 1, 37, 12, 1, 13);
