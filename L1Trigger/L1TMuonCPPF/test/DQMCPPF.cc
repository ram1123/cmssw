...
void DQM_CPPF::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup){  
  ...
  for(auto& cppf_digis : *CppfDigis1){
    ...
    for(auto& cppf_digis2 : *CppfDigis2){
      ...
      //std::cout <<"boardCe == "<<boardCe << "\tboardCu == " << boardCu << std::endl;
      //std::cout << "channelCu = " << channelCu << "\tchannelCe = " << channelCe << std::endl;
      ...
      if (matches_unpacker_bx == 1) {
         ...
         if (ar_thetaIntCe_bx[0] == ar_thetaIntCu_bx[0]) {
            h1_cluster_sizeCe_bx_oneHit_OnTheta->Fill(ar_cluster_sizeCe_bx[0]);
            h1_cluster_sizeCu_bx_oneHit_OnTheta->Fill(ar_cluster_sizeCu_bx[0]);
            h1_bxCe_bx_oneHit_OnTheta->Fill(ar_bxCe_bx[0]);
            h1_bxCu_bx_oneHit_OnTheta->Fill(ar_bxCu_bx[0]);
            h1_phiIntCe_bx_oneHit_OnTheta->Fill(ar_phiIntCe_bx[0]);
            h1_phiIntCu_bx_oneHit_OnTheta->Fill(ar_phiIntCu_bx[0]);
            h1_thetaIntCu_bx_oneHit_OnTheta->Fill(ar_thetaIntCu_bx[0]);
            h1_thetaIntCe_bx_oneHit_OnTheta->Fill(ar_thetaIntCe_bx[0]);
            h1_thetaGlobalCe_bx_oneHit_OnTheta->Fill(ar_thetaGlobalCe_bx[0]);
            h1_thetaGlobalCu_bx_oneHit_OnTheta->Fill(ar_thetaGlobalCu_bx[0]);
            h1_phiGlobalCe_bx_oneHit_OnTheta->Fill(ar_phiGlobalCe_bx[0]);
            h1_phiGlobalCu_bx_oneHit_OnTheta->Fill(ar_phiGlobalCu_bx[0]);
            h2_bx_emu_unpack_bx_oneHit_OnTheta->Fill(ar_bxCe_bx[0], ar_bxCu_bx[0]);
            h2_phiInt_emu_unpack_bx_oneHit_OnTheta->Fill(ar_phiIntCe_bx[0], ar_phiIntCu_bx[0]);
            h2_phiGlobal_emu_unpack_bx_oneHit_OnTheta->Fill(ar_phiGlobalCe_bx[0], ar_phiGlobalCu_bx[0]);
            h2_thetaInt_emu_unpack_bx_oneHit_OnTheta->Fill(ar_thetaIntCe_bx[0], ar_thetaIntCu_bx[0]);
            h2_thetaGlobal_emu_unpack_bx_oneHit_OnTheta->Fill(ar_thetaGlobalCe_bx[0], ar_thetaGlobalCu_bx[0]);
            h2_chamberID_emu_unpack_bx_oneHit_OnTheta->Fill(ar_chamberIDCe_bx[0], ar_chamberIDCu_bx[0]);
            h2_chamberID_vs_roll_emu_bx_oneHit_OnTheta->Fill(ar_chamberIDCe_bx[0], ar_rollCe_bx[0]);
            h2_chamberID_vs_roll_unpack_bx_oneHit_OnTheta->Fill(ar_chamberIDCu_bx[0], ar_rollCu_bx[0]);
            h2_occupancy_unpacker_bx_oneHit_OnTheta->Fill(ar_emtfSubsectorCu_bx[0], ar_fillOccupancyCu_bx[0]);
            h2_occupancy_emulator_bx_oneHit_OnTheta->Fill(ar_emtfSubsectorCe_bx[0], ar_fillOccupancyCe_bx[0]);
         } else {
            h1_cluster_sizeCe_bx_oneHit_OffTheta->Fill(ar_cluster_sizeCe_bx[0]);
            h1_cluster_sizeCu_bx_oneHit_OffTheta->Fill(ar_cluster_sizeCu_bx[0]);
            h1_bxCe_bx_oneHit_OffTheta->Fill(ar_bxCe_bx[0]);
            h1_bxCu_bx_oneHit_OffTheta->Fill(ar_bxCu_bx[0]);
            h1_phiIntCe_bx_oneHit_OffTheta->Fill(ar_phiIntCe_bx[0]);
            h1_phiIntCu_bx_oneHit_OffTheta->Fill(ar_phiIntCu_bx[0]);
            h1_thetaIntCu_bx_oneHit_OffTheta->Fill(ar_thetaIntCu_bx[0]);
            h1_thetaIntCe_bx_oneHit_OffTheta->Fill(ar_thetaIntCe_bx[0]);
            h1_thetaGlobalCe_bx_oneHit_OffTheta->Fill(ar_thetaGlobalCe_bx[0]);
            h1_thetaGlobalCu_bx_oneHit_OffTheta->Fill(ar_thetaGlobalCu_bx[0]);
            h1_phiGlobalCe_bx_oneHit_OffTheta->Fill(ar_phiGlobalCe_bx[0]);
            h1_phiGlobalCu_bx_oneHit_OffTheta->Fill(ar_phiGlobalCu_bx[0]);
            h2_bx_emu_unpack_bx_oneHit_OffTheta->Fill(ar_bxCe_bx[0], ar_bxCu_bx[0]);
            h2_phiInt_emu_unpack_bx_oneHit_OffTheta->Fill(ar_phiIntCe_bx[0], ar_phiIntCu_bx[0]);
            h2_phiGlobal_emu_unpack_bx_oneHit_OffTheta->Fill(ar_phiGlobalCe_bx[0], ar_phiGlobalCu_bx[0]);
            h2_thetaInt_emu_unpack_bx_oneHit_OffTheta->Fill(ar_thetaIntCe_bx[0], ar_thetaIntCu_bx[0]);
            h2_thetaGlobal_emu_unpack_bx_oneHit_OffTheta->Fill(ar_thetaGlobalCe_bx[0], ar_thetaGlobalCu_bx[0]);
            h2_chamberID_emu_unpack_bx_oneHit_OffTheta->Fill(ar_chamberIDCe_bx[0], ar_chamberIDCu_bx[0]);
            h2_chamberID_vs_roll_emu_bx_oneHit_OffTheta->Fill(ar_chamberIDCe_bx[0], ar_rollCe_bx[0]);
            h2_chamberID_vs_roll_unpack_bx_oneHit_OffTheta->Fill(ar_chamberIDCu_bx[0], ar_rollCu_bx[0]);
            h2_occupancy_unpacker_bx_oneHit_OffTheta->Fill(ar_emtfSubsectorCu_bx[0], ar_fillOccupancyCu_bx[0]);
            h2_occupancy_emulator_bx_oneHit_OffTheta->Fill(ar_emtfSubsectorCe_bx[0], ar_fillOccupancyCe_bx[0]);
         }
      }  // matches_unpacker_bx == 1
    
    /*
     Here if loop decides for how many number of hits you are interested in.
     */
      if (matches_unpacker_bx) {
         //std::cout<<"Size of one hit event = " << ar_cluster_sizeCe.size() << std::endl;
         //std::cout<<"phi int unpacker ar_phiIntCu = " << ar_phiIntCu_bx[0] << std::endl;
         //std::cout<<"phi int emulator ar_phiIntCe = " << ar_phiIntCe_bx[0] << std::endl;
...
//             std::cout << "matches_unpacker_bx = " << matches_unpacker_bx << "\t matches = " << matches << std::endl;
            h1_cluster_sizeCe_bx_InclusiveHit->Fill(ar_cluster_sizeCe_bx[matches]);
            h1_cluster_sizeCu_bx_InclusiveHit->Fill(ar_cluster_sizeCu_bx[matches]);
            h1_bxCe_bx_InclusiveHit->Fill(ar_bxCe_bx[matches]);
            h1_bxCu_bx_InclusiveHit->Fill(ar_bxCu_bx[matches]);
            h1_phiIntCe_bx_InclusiveHit->Fill(ar_phiIntCe_bx[matches]);
            h1_phiIntCu_bx_InclusiveHit->Fill(ar_phiIntCu_bx[matches]);
            h1_thetaIntCu_bx_InclusiveHit->Fill(ar_thetaIntCu_bx[matches]);
            h1_thetaIntCe_bx_InclusiveHit->Fill(ar_thetaIntCe_bx[matches]);
            h1_thetaGlobalCe_bx_InclusiveHit->Fill(ar_thetaGlobalCe_bx[matches]);
            h1_thetaGlobalCu_bx_InclusiveHit->Fill(ar_thetaGlobalCu_bx[matches]);
            h1_phiGlobalCe_bx_InclusiveHit->Fill(ar_phiGlobalCe_bx[matches]);
            h1_phiGlobalCu_bx_InclusiveHit->Fill(ar_phiGlobalCu_bx[matches]);
            h2_bx_emu_unpack_bx_InclusiveHit->Fill(ar_bxCe_bx[matches], ar_bxCu_bx[matches]);
            h2_phiInt_emu_unpack_bx_InclusiveHit->Fill(ar_phiIntCe_bx[matches], ar_phiIntCu_bx[matches]);
            h2_phiGlobal_emu_unpack_bx_InclusiveHit->Fill(ar_phiGlobalCe_bx[matches], ar_phiGlobalCu_bx[matches]);
            h2_thetaInt_emu_unpack_bx_InclusiveHit->Fill(ar_thetaIntCe_bx[matches], ar_thetaIntCu_bx[matches]);
            h2_thetaGlobal_emu_unpack_bx_InclusiveHit->Fill(ar_thetaGlobalCe_bx[matches], ar_thetaGlobalCu_bx[matches]);
            h2_chamberID_emu_unpack_bx_InclusiveHit->Fill(ar_chamberIDCe_bx[matches], ar_chamberIDCu_bx[matches]);
            h2_chamberID_vs_roll_emu_bx_InclusiveHit->Fill(ar_chamberIDCe_bx[matches], ar_rollCe_bx[matches]);
            h2_chamberID_vs_roll_unpack_bx_InclusiveHit->Fill(ar_chamberIDCu_bx[matches], ar_rollCu_bx[matches]);
            h2_occupancy_unpacker_bx_InclusiveHit->Fill(ar_emtfSubsectorCu_bx[matches], ar_fillOccupancyCu_bx[matches]);
            h2_occupancy_emulator_bx_InclusiveHit->Fill(ar_emtfSubsectorCe_bx[matches], ar_fillOccupancyCe_bx[matches]);
            ...
            if (onphi) {
               h1_cluster_sizeCe_bx_InclusiveHit_OnPhi->Fill(ar_cluster_sizeCe_bx[first]);
               h1_cluster_sizeCu_bx_InclusiveHit_OnPhi->Fill(ar_cluster_sizeCu_bx[second]);
               h1_bxCe_bx_InclusiveHit_OnPhi->Fill(ar_bxCe_bx[first]);
               h1_bxCu_bx_InclusiveHit_OnPhi->Fill(ar_bxCu_bx[second]);
               h1_phiIntCe_bx_InclusiveHit_OnPhi->Fill(ar_phiIntCe_bx[first]);
               h1_phiIntCu_bx_InclusiveHit_OnPhi->Fill(ar_phiIntCu_bx[second]);
               h1_thetaIntCu_bx_InclusiveHit_OnPhi->Fill(ar_thetaIntCu_bx[second]);
               h1_thetaIntCe_bx_InclusiveHit_OnPhi->Fill(ar_thetaIntCe_bx[first]);
               h1_thetaGlobalCe_bx_InclusiveHit_OnPhi->Fill(ar_thetaGlobalCe_bx[first]);
               h1_thetaGlobalCu_bx_InclusiveHit_OnPhi->Fill(ar_thetaGlobalCu_bx[second]);
               h1_phiGlobalCe_bx_InclusiveHit_OnPhi->Fill(ar_phiGlobalCe_bx[first]);
               h1_phiGlobalCu_bx_InclusiveHit_OnPhi->Fill(ar_phiGlobalCu_bx[second]);
               h2_bx_emu_unpack_bx_InclusiveHit_OnPhi->Fill(ar_bxCe_bx[first], ar_bxCu_bx[second]);
               h2_phiInt_emu_unpack_bx_InclusiveHit_OnPhi->Fill(ar_phiIntCe_bx[first], ar_phiIntCu_bx[second]);
               h2_phiGlobal_emu_unpack_bx_InclusiveHit_OnPhi->Fill(ar_phiGlobalCe_bx[first], ar_phiGlobalCu_bx[second]);
               h2_thetaInt_emu_unpack_bx_InclusiveHit_OnPhi->Fill(ar_thetaIntCe_bx[first], ar_thetaIntCu_bx[second]);
               h2_thetaGlobal_emu_unpack_bx_InclusiveHit_OnPhi->Fill(ar_thetaGlobalCe_bx[first], ar_thetaGlobalCu_bx[second]);
               h2_chamberID_emu_unpack_bx_InclusiveHit_OnPhi->Fill(ar_chamberIDCe_bx[first], ar_chamberIDCu_bx[second]);
               h2_chamberID_vs_roll_emu_bx_InclusiveHit_OnPhi->Fill(ar_chamberIDCe_bx[first], ar_rollCe_bx[first]);
               h2_chamberID_vs_roll_unpack_bx_InclusiveHit_OnPhi->Fill(ar_chamberIDCu_bx[second], ar_rollCu_bx[second]);
               h2_occupancy_unpacker_bx_InclusiveHit_OnPhi->Fill(ar_emtfSubsectorCu_bx[second], ar_fillOccupancyCu_bx[second]);
               h2_occupancy_emulator_bx_InclusiveHit_OnPhi->Fill(ar_emtfSubsectorCe_bx[first], ar_fillOccupancyCe_bx[first]);
            } else {
               h1_cluster_sizeCe_bx_InclusiveHit_OffPhi->Fill(ar_cluster_sizeCe_bx[matches]);
               h1_cluster_sizeCu_bx_InclusiveHit_OffPhi->Fill(ar_cluster_sizeCu_bx[matches]);
               h1_bxCe_bx_InclusiveHit_OffPhi->Fill(ar_bxCe_bx[matches]);
               h1_bxCu_bx_InclusiveHit_OffPhi->Fill(ar_bxCu_bx[matches]);
               h1_phiIntCe_bx_InclusiveHit_OffPhi->Fill(ar_phiIntCe_bx[matches]);
               h1_phiIntCu_bx_InclusiveHit_OffPhi->Fill(ar_phiIntCu_bx[matches]);
               h1_thetaIntCu_bx_InclusiveHit_OffPhi->Fill(ar_thetaIntCu_bx[matches]);
               h1_thetaIntCe_bx_InclusiveHit_OffPhi->Fill(ar_thetaIntCe_bx[matches]);
               h1_thetaGlobalCe_bx_InclusiveHit_OffPhi->Fill(ar_thetaGlobalCe_bx[matches]);
               h1_thetaGlobalCu_bx_InclusiveHit_OffPhi->Fill(ar_thetaGlobalCu_bx[matches]);
               h1_phiGlobalCe_bx_InclusiveHit_OffPhi->Fill(ar_phiGlobalCe_bx[matches]);
               h1_phiGlobalCu_bx_InclusiveHit_OffPhi->Fill(ar_phiGlobalCu_bx[matches]);
               h2_bx_emu_unpack_bx_InclusiveHit_OffPhi->Fill(ar_bxCe_bx[matches], ar_bxCu_bx[matches]);
               h2_phiInt_emu_unpack_bx_InclusiveHit_OffPhi->Fill(ar_phiIntCe_bx[matches], ar_phiIntCu_bx[matches]);
               h2_phiGlobal_emu_unpack_bx_InclusiveHit_OffPhi->Fill(ar_phiGlobalCe_bx[matches], ar_phiGlobalCu_bx[matches]);
               h2_thetaInt_emu_unpack_bx_InclusiveHit_OffPhi->Fill(ar_thetaIntCe_bx[matches], ar_thetaIntCu_bx[matches]);
               h2_thetaGlobal_emu_unpack_bx_InclusiveHit_OffPhi->Fill(ar_thetaGlobalCe_bx[matches], ar_thetaGlobalCu_bx[matches]);
               h2_chamberID_emu_unpack_bx_InclusiveHit_OffPhi->Fill(ar_chamberIDCe_bx[matches], ar_chamberIDCu_bx[matches]);
               h2_chamberID_vs_roll_emu_bx_InclusiveHit_OffPhi->Fill(ar_chamberIDCe_bx[matches], ar_rollCe_bx[matches]);
               h2_chamberID_vs_roll_unpack_bx_InclusiveHit_OffPhi->Fill(ar_chamberIDCu_bx[matches], ar_rollCu_bx[matches]);
               h2_occupancy_unpacker_bx_InclusiveHit_OffPhi->Fill(ar_emtfSubsectorCu_bx[matches], ar_fillOccupancyCu_bx[matches]);
               h2_occupancy_emulator_bx_InclusiveHit_OffPhi->Fill(ar_emtfSubsectorCe_bx[matches], ar_fillOccupancyCe_bx[matches]);
            }
            ...
            if (ontheta) {
               h1_cluster_sizeCe_bx_InclusiveHit_OnTheta->Fill(ar_cluster_sizeCe_bx[first]);
               h1_cluster_sizeCu_bx_InclusiveHit_OnTheta->Fill(ar_cluster_sizeCu_bx[second]);
               h1_bxCe_bx_InclusiveHit_OnTheta->Fill(ar_bxCe_bx[first]);
               h1_bxCu_bx_InclusiveHit_OnTheta->Fill(ar_bxCu_bx[second]);
               h1_phiIntCe_bx_InclusiveHit_OnTheta->Fill(ar_phiIntCe_bx[first]);
               h1_phiIntCu_bx_InclusiveHit_OnTheta->Fill(ar_phiIntCu_bx[second]);
               h1_thetaIntCu_bx_InclusiveHit_OnTheta->Fill(ar_thetaIntCu_bx[second]);
               h1_thetaIntCe_bx_InclusiveHit_OnTheta->Fill(ar_thetaIntCe_bx[first]);
               h1_thetaGlobalCe_bx_InclusiveHit_OnTheta->Fill(ar_thetaGlobalCe_bx[first]);
               h1_thetaGlobalCu_bx_InclusiveHit_OnTheta->Fill(ar_thetaGlobalCu_bx[second]);
               h1_phiGlobalCe_bx_InclusiveHit_OnTheta->Fill(ar_phiGlobalCe_bx[first]);
               h1_phiGlobalCu_bx_InclusiveHit_OnTheta->Fill(ar_phiGlobalCu_bx[second]);
               h2_bx_emu_unpack_bx_InclusiveHit_OnTheta->Fill(ar_bxCe_bx[first], ar_bxCu_bx[second]);
               h2_phiInt_emu_unpack_bx_InclusiveHit_OnTheta->Fill(ar_phiIntCe_bx[first], ar_phiIntCu_bx[second]);
               h2_phiGlobal_emu_unpack_bx_InclusiveHit_OnTheta->Fill(ar_phiGlobalCe_bx[first], ar_phiGlobalCu_bx[second]);
               h2_thetaInt_emu_unpack_bx_InclusiveHit_OnTheta->Fill(ar_thetaIntCe_bx[first], ar_thetaIntCu_bx[second]);
               h2_thetaGlobal_emu_unpack_bx_InclusiveHit_OnTheta->Fill(ar_thetaGlobalCe_bx[first], ar_thetaGlobalCu_bx[second]);
               h2_chamberID_emu_unpack_bx_InclusiveHit_OnTheta->Fill(ar_chamberIDCe_bx[first], ar_chamberIDCu_bx[second]);
               h2_chamberID_vs_roll_emu_bx_InclusiveHit_OnTheta->Fill(ar_chamberIDCe_bx[first], ar_rollCe_bx[first]);
               h2_chamberID_vs_roll_unpack_bx_InclusiveHit_OnTheta->Fill(ar_chamberIDCu_bx[second], ar_rollCu_bx[second]);
               h2_occupancy_unpacker_bx_InclusiveHit_OnTheta->Fill(ar_emtfSubsectorCu_bx[second], ar_fillOccupancyCu_bx[second]);
               h2_occupancy_emulator_bx_InclusiveHit_OnTheta->Fill(ar_emtfSubsectorCe_bx[first], ar_fillOccupancyCe_bx[first]);
            } else {
               h1_cluster_sizeCe_bx_InclusiveHit_OffTheta->Fill(ar_cluster_sizeCe_bx[matches]);
               h1_cluster_sizeCu_bx_InclusiveHit_OffTheta->Fill(ar_cluster_sizeCu_bx[matches]);
               h1_bxCe_bx_InclusiveHit_OffTheta->Fill(ar_bxCe_bx[matches]);
               h1_bxCu_bx_InclusiveHit_OffTheta->Fill(ar_bxCu_bx[matches]);
               h1_phiIntCe_bx_InclusiveHit_OffTheta->Fill(ar_phiIntCe_bx[matches]);
               h1_phiIntCu_bx_InclusiveHit_OffTheta->Fill(ar_phiIntCu_bx[matches]);
               h1_thetaIntCu_bx_InclusiveHit_OffTheta->Fill(ar_thetaIntCu_bx[matches]);
               h1_thetaIntCe_bx_InclusiveHit_OffTheta->Fill(ar_thetaIntCe_bx[matches]);
               h1_thetaGlobalCe_bx_InclusiveHit_OffTheta->Fill(ar_thetaGlobalCe_bx[matches]);
               h1_thetaGlobalCu_bx_InclusiveHit_OffTheta->Fill(ar_thetaGlobalCu_bx[matches]);
               h1_phiGlobalCe_bx_InclusiveHit_OffTheta->Fill(ar_phiGlobalCe_bx[matches]);
               h1_phiGlobalCu_bx_InclusiveHit_OffTheta->Fill(ar_phiGlobalCu_bx[matches]);
               h2_bx_emu_unpack_bx_InclusiveHit_OffTheta->Fill(ar_bxCe_bx[matches], ar_bxCu_bx[matches]);
               h2_phiInt_emu_unpack_bx_InclusiveHit_OffTheta->Fill(ar_phiIntCe_bx[matches], ar_phiIntCu_bx[matches]);
               h2_phiGlobal_emu_unpack_bx_InclusiveHit_OffTheta->Fill(ar_phiGlobalCe_bx[matches], ar_phiGlobalCu_bx[matches]);
               h2_thetaInt_emu_unpack_bx_InclusiveHit_OffTheta->Fill(ar_thetaIntCe_bx[matches], ar_thetaIntCu_bx[matches]);
               h2_thetaGlobal_emu_unpack_bx_InclusiveHit_OffTheta->Fill(ar_thetaGlobalCe_bx[matches], ar_thetaGlobalCu_bx[matches]);
               h2_chamberID_emu_unpack_bx_InclusiveHit_OffTheta->Fill(ar_chamberIDCe_bx[matches], ar_chamberIDCu_bx[matches]);
               h2_chamberID_vs_roll_emu_bx_InclusiveHit_OffTheta->Fill(ar_chamberIDCe_bx[matches], ar_rollCe_bx[matches]);
               h2_chamberID_vs_roll_unpack_bx_InclusiveHit_OffTheta->Fill(ar_chamberIDCu_bx[matches], ar_rollCu_bx[matches]);
               h2_occupancy_unpacker_bx_InclusiveHit_OffTheta->Fill(ar_emtfSubsectorCu_bx[matches], ar_fillOccupancyCu_bx[matches]);
               h2_occupancy_emulator_bx_InclusiveHit_OffTheta->Fill(ar_emtfSubsectorCe_bx[matches], ar_fillOccupancyCe_bx[matches]);
            }
            }  // END: for (int matches=0; matches<2; matches++) 
      }  // matches_unpacker_bx == 2
...
void DQM_CPPF::beginJob(){
  ...
  h1_cluster_sizeCe_bx_InclusiveHit = fs->make<TH1D>("h1_cluster_sizeCe_bx_InclusiveHit", "Cluster size of emulator with same BX", 10, 0., 10.);
  h1_cluster_sizeCe_bx_InclusiveHit_OnTheta = fs->make<TH1D>("h1_cluster_sizeCe_bx_InclusiveHit_OnTheta", "Cluster size of emulator with same BX", 10, 0., 10.);
  h1_cluster_sizeCe_bx_InclusiveHit_OffTheta = fs->make<TH1D>("h1_cluster_sizeCe_bx_InclusiveHit_OffTheta", "Cluster size of emulator with same BX", 10, 0., 10.);
  h1_cluster_sizeCe_bx_InclusiveHit_OnPhi = fs->make<TH1D>("h1_cluster_sizeCe_bx_InclusiveHit_OnPhi", "Cluster size of emulator with same BX", 10, 0., 10.);
  h1_cluster_sizeCe_bx_InclusiveHit_OffPhi = fs->make<TH1D>("h1_cluster_sizeCe_bx_InclusiveHit_OffPhi", "Cluster size of emulator with same BX", 10, 0., 10.);
  h1_cluster_sizeCe_bx_oneHit_OnTheta = fs->make<TH1D>("h1_cluster_sizeCe_bx_oneHit_OnTheta", "Cluster size of emulator with same BX", 10, 0., 10.);
  h1_cluster_sizeCe_bx_oneHit_OffTheta = fs->make<TH1D>("h1_cluster_sizeCe_bx_oneHit_OffTheta", "Cluster size of emulator with same BX", 10, 0., 10.);
  ...
  h1_cluster_sizeCu_bx_InclusiveHit = fs->make<TH1D>("h1_cluster_sizeCu_bx_InclusiveHit", "Cluster size of emulator with same BX", 10, 0., 10.);
  h1_cluster_sizeCu_bx_InclusiveHit_OnTheta = fs->make<TH1D>("h1_cluster_sizeCu_bx_InclusiveHit_OnTheta", "Cluster size of emulator with same BX", 10, 0., 10.);
  h1_cluster_sizeCu_bx_InclusiveHit_OffTheta = fs->make<TH1D>("h1_cluster_sizeCu_bx_InclusiveHit_OffTheta", "Cluster size of emulator with same BX", 10, 0., 10.);
  h1_cluster_sizeCu_bx_InclusiveHit_OnPhi = fs->make<TH1D>("h1_cluster_sizeCu_bx_InclusiveHit_OnPhi", "Cluster size of emulator with same BX", 10, 0., 10.);
  h1_cluster_sizeCu_bx_InclusiveHit_OffPhi = fs->make<TH1D>("h1_cluster_sizeCu_bx_InclusiveHit_OffPhi", "Cluster size of emulator with same BX", 10, 0., 10.);
  h1_cluster_sizeCu_bx_oneHit_OnTheta = fs->make<TH1D>("h1_cluster_sizeCu_bx_oneHit_OnTheta", "Cluster size of emulator with same BX", 10, 0., 10.);
  h1_cluster_sizeCu_bx_oneHit_OffTheta = fs->make<TH1D>("h1_cluster_sizeCu_bx_oneHit_OffTheta", "Cluster size of emulator with same BX", 10, 0., 10.);
  ...
  h1_bxCe_bx_InclusiveHit = fs->make<TH1D>("h1_bxCe_bx_InclusiveHit", "h1_bxCe_bx", 8, -4., 4.);
  h1_bxCe_bx_InclusiveHit_OnTheta = fs->make<TH1D>("h1_bxCe_bx_InclusiveHit_OnTheta", "h1_bxCe_bx", 8, -4., 4.);
  h1_bxCe_bx_InclusiveHit_OffTheta = fs->make<TH1D>("h1_bxCe_bx_InclusiveHit_OffTheta", "h1_bxCe_bx", 8, -4., 4.);
  h1_bxCe_bx_InclusiveHit_OnPhi = fs->make<TH1D>("h1_bxCe_bx_InclusiveHit_OnPhi", "h1_bxCe_bx", 8, -4., 4.);
  h1_bxCe_bx_InclusiveHit_OffPhi = fs->make<TH1D>("h1_bxCe_bx_InclusiveHit_OffPhi", "h1_bxCe_bx", 8, -4., 4.);
  h1_bxCe_bx_oneHit_OnTheta = fs->make<TH1D>("h1_bxCe_bx_oneHit_OnTheta", "h1_bxCe_bx", 8, -4., 4.);
  h1_bxCe_bx_oneHit_OffTheta = fs->make<TH1D>("h1_bxCe_bx_oneHit_OffTheta", "h1_bxCe_bx", 8, -4., 4.);
  ...
  h1_bxCu_bx_InclusiveHit = fs->make<TH1D>("h1_bxCu_bx_InclusiveHit", "h1_bxCu_bx", 8, -4., 4.);
  h1_bxCu_bx_InclusiveHit_OnTheta = fs->make<TH1D>("h1_bxCu_bx_InclusiveHit_OnTheta", "h1_bxCu_bx", 8, -4., 4.);
  h1_bxCu_bx_InclusiveHit_OffTheta = fs->make<TH1D>("h1_bxCu_bx_InclusiveHit_OffTheta", "h1_bxCu_bx", 8, -4., 4.);
  h1_bxCu_bx_InclusiveHit_OnPhi = fs->make<TH1D>("h1_bxCu_bx_InclusiveHit_OnPhi", "h1_bxCu_bx", 8, -4., 4.);
  h1_bxCu_bx_InclusiveHit_OffPhi = fs->make<TH1D>("h1_bxCu_bx_InclusiveHit_OffPhi", "h1_bxCu_bx", 8, -4., 4.);
  h1_bxCu_bx_oneHit_OnTheta = fs->make<TH1D>("h1_bxCu_bx_oneHit_OnTheta", "h1_bxCu_bx", 8, -4., 4.);
  h1_bxCu_bx_oneHit_OffTheta = fs->make<TH1D>("h1_bxCu_bx_oneHit_OffTheta", "h1_bxCu_bx", 8, -4., 4.);
  ...
  h1_phiIntCe_bx_InclusiveHit = fs->make<TH1D>("h1_phiIntCe_bx_InclusiveHit", "h1_phiIntCe_bx", 124, 0., 1240.);
  h1_phiIntCe_bx_InclusiveHit_OnTheta = fs->make<TH1D>("h1_phiIntCe_bx_InclusiveHit_OnTheta", "h1_phiIntCe_bx", 124, 0., 1240.);
  h1_phiIntCe_bx_InclusiveHit_OffTheta = fs->make<TH1D>("h1_phiIntCe_bx_InclusiveHit_OffTheta", "h1_phiIntCe_bx", 124, 0., 1240.);
  h1_phiIntCe_bx_InclusiveHit_OnPhi = fs->make<TH1D>("h1_phiIntCe_bx_InclusiveHit_OnPhi", "h1_phiIntCe_bx", 124, 0., 1240.);
  h1_phiIntCe_bx_InclusiveHit_OffPhi = fs->make<TH1D>("h1_phiIntCe_bx_InclusiveHit_OffPhi", "h1_phiIntCe_bx", 124, 0., 1240.);
  h1_phiIntCe_bx_oneHit_OnTheta = fs->make<TH1D>("h1_phiIntCe_bx_oneHit_OnTheta", "h1_phiIntCe_bx", 124, 0., 1240.);
  h1_phiIntCe_bx_oneHit_OffTheta = fs->make<TH1D>("h1_phiIntCe_bx_oneHit_OffTheta", "h1_phiIntCe_bx", 124, 0., 1240.);
  ...
  h1_phiIntCu_bx_InclusiveHit = fs->make<TH1D>("h1_phiIntCu_bx_InclusiveHit", "h1_phiIntCu_bx", 124, 0., 1240.);
  h1_phiIntCu_bx_InclusiveHit_OnTheta = fs->make<TH1D>("h1_phiIntCu_bx_InclusiveHit_OnTheta", "h1_phiIntCu_bx", 124, 0., 1240.);
  h1_phiIntCu_bx_InclusiveHit_OffTheta = fs->make<TH1D>("h1_phiIntCu_bx_InclusiveHit_OffTheta", "h1_phiIntCu_bx", 124, 0., 1240.);
  h1_phiIntCu_bx_InclusiveHit_OnPhi = fs->make<TH1D>("h1_phiIntCu_bx_InclusiveHit_OnPhi", "h1_phiIntCu_bx", 124, 0., 1240.);
  h1_phiIntCu_bx_InclusiveHit_OffPhi = fs->make<TH1D>("h1_phiIntCu_bx_InclusiveHit_OffPhi", "h1_phiIntCu_bx", 124, 0., 1240.);
  h1_phiIntCu_bx_oneHit_OnTheta = fs->make<TH1D>("h1_phiIntCu_bx_oneHit_OnTheta", "h1_phiIntCu_bx", 124, 0., 1240.);
  h1_phiIntCu_bx_oneHit_OffTheta = fs->make<TH1D>("h1_phiIntCu_bx_oneHit_OffTheta", "h1_phiIntCu_bx", 124, 0., 1240.);
  ...
  h1_thetaIntCu_bx_InclusiveHit = fs->make<TH1D>("h1_thetaIntCu_bx_InclusiveHit", "h1_thetaIntCu_bx", 32, 0., 32.);
  h1_thetaIntCu_bx_InclusiveHit_OnTheta = fs->make<TH1D>("h1_thetaIntCu_bx_InclusiveHit_OnTheta", "h1_thetaIntCu_bx", 32, 0., 32.);
  h1_thetaIntCu_bx_InclusiveHit_OffTheta = fs->make<TH1D>("h1_thetaIntCu_bx_InclusiveHit_OffTheta", "h1_thetaIntCu_bx", 32, 0., 32.);
  h1_thetaIntCu_bx_InclusiveHit_OnPhi = fs->make<TH1D>("h1_thetaIntCu_bx_InclusiveHit_OnPhi", "h1_thetaIntCu_bx", 32, 0., 32.);
  h1_thetaIntCu_bx_InclusiveHit_OffPhi = fs->make<TH1D>("h1_thetaIntCu_bx_InclusiveHit_OffPhi", "h1_thetaIntCu_bx", 32, 0., 32.);
  h1_thetaIntCu_bx_oneHit_OnTheta = fs->make<TH1D>("h1_thetaIntCu_bx_oneHit_OnTheta", "h1_thetaIntCu_bx", 32, 0., 32.);
  h1_thetaIntCu_bx_oneHit_OffTheta = fs->make<TH1D>("h1_thetaIntCu_bx_oneHit_OffTheta", "h1_thetaIntCu_bx", 32, 0., 32.);
  ...
  h1_thetaIntCe_bx_InclusiveHit = fs->make<TH1D>("h1_thetaIntCe_bx_InclusiveHit", "h1_thetaIntCe_bx", 32, 0., 32.);
  h1_thetaIntCe_bx_InclusiveHit_OnTheta = fs->make<TH1D>("h1_thetaIntCe_bx_InclusiveHit_OnTheta", "h1_thetaIntCe_bx", 32, 0., 32.);
  h1_thetaIntCe_bx_InclusiveHit_OffTheta = fs->make<TH1D>("h1_thetaIntCe_bx_InclusiveHit_OffTheta", "h1_thetaIntCe_bx", 32, 0., 32.);
  h1_thetaIntCe_bx_InclusiveHit_OnPhi = fs->make<TH1D>("h1_thetaIntCe_bx_InclusiveHit_OnPhi", "h1_thetaIntCe_bx", 32, 0., 32.);
  h1_thetaIntCe_bx_InclusiveHit_OffPhi = fs->make<TH1D>("h1_thetaIntCe_bx_InclusiveHit_OffPhi", "h1_thetaIntCe_bx", 32, 0., 32.);
  h1_thetaIntCe_bx_oneHit_OnTheta = fs->make<TH1D>("h1_thetaIntCe_bx_oneHit_OnTheta", "h1_thetaIntCe_bx", 32, 0., 32.);
  h1_thetaIntCe_bx_oneHit_OffTheta = fs->make<TH1D>("h1_thetaIntCe_bx_oneHit_OffTheta", "h1_thetaIntCe_bx", 32, 0., 32.);
  ...
  h1_thetaGlobalCe_bx_InclusiveHit = fs->make<TH1D>("h1_thetaGlobalCe_bx_InclusiveHit", "h1_thetaGlobalCe_bx", 180,0.,180.);
  h1_thetaGlobalCe_bx_InclusiveHit_OnTheta = fs->make<TH1D>("h1_thetaGlobalCe_bx_InclusiveHit_OnTheta", "h1_thetaGlobalCe_bx", 180,0.,180.);
  h1_thetaGlobalCe_bx_InclusiveHit_OffTheta = fs->make<TH1D>("h1_thetaGlobalCe_bx_InclusiveHit_OffTheta", "h1_thetaGlobalCe_bx", 180,0.,180.);
  h1_thetaGlobalCe_bx_InclusiveHit_OnPhi = fs->make<TH1D>("h1_thetaGlobalCe_bx_InclusiveHit_OnPhi", "h1_thetaGlobalCe_bx", 180,0.,180.);
  h1_thetaGlobalCe_bx_InclusiveHit_OffPhi = fs->make<TH1D>("h1_thetaGlobalCe_bx_InclusiveHit_OffPhi", "h1_thetaGlobalCe_bx", 180,0.,180.);
  h1_thetaGlobalCe_bx_oneHit_OnTheta = fs->make<TH1D>("h1_thetaGlobalCe_bx_oneHit_OnTheta", "h1_thetaGlobalCe_bx", 180,0.,180.);
  h1_thetaGlobalCe_bx_oneHit_OffTheta = fs->make<TH1D>("h1_thetaGlobalCe_bx_oneHit_OffTheta", "h1_thetaGlobalCe_bx", 180,0.,180.);
  ...
  h1_thetaGlobalCu_bx_InclusiveHit = fs->make<TH1D>("h1_thetaGlobalCu_bx_InclusiveHit", "h1_thetaGlobalCu_bx", 180,0.,180.);
  h1_thetaGlobalCu_bx_InclusiveHit_OnTheta = fs->make<TH1D>("h1_thetaGlobalCu_bx_InclusiveHit_OnTheta", "h1_thetaGlobalCu_bx", 180,0.,180.);
  h1_thetaGlobalCu_bx_InclusiveHit_OffTheta = fs->make<TH1D>("h1_thetaGlobalCu_bx_InclusiveHit_OffTheta", "h1_thetaGlobalCu_bx", 180,0.,180.);
  h1_thetaGlobalCu_bx_InclusiveHit_OnPhi = fs->make<TH1D>("h1_thetaGlobalCu_bx_InclusiveHit_OnPhi", "h1_thetaGlobalCu_bx", 180,0.,180.);
  h1_thetaGlobalCu_bx_InclusiveHit_OffPhi = fs->make<TH1D>("h1_thetaGlobalCu_bx_InclusiveHit_OffPhi", "h1_thetaGlobalCu_bx", 180,0.,180.);
  h1_thetaGlobalCu_bx_oneHit_OnTheta = fs->make<TH1D>("h1_thetaGlobalCu_bx_oneHit_OnTheta", "h1_thetaGlobalCu_bx", 180,0.,180.);
  h1_thetaGlobalCu_bx_oneHit_OffTheta = fs->make<TH1D>("h1_thetaGlobalCu_bx_oneHit_OffTheta", "h1_thetaGlobalCu_bx", 180,0.,180.);
  ...
  h1_phiGlobalCe_bx_InclusiveHit = fs->make<TH1D>("h1_phiGlobalCe_bx_InclusiveHit", "h1_phiGlobalCe_bx", 360,-180.,180);
  h1_phiGlobalCe_bx_InclusiveHit_OnTheta = fs->make<TH1D>("h1_phiGlobalCe_bx_InclusiveHit_OnTheta", "h1_phiGlobalCe_bx", 360,-180.,180);
  h1_phiGlobalCe_bx_InclusiveHit_OffTheta = fs->make<TH1D>("h1_phiGlobalCe_bx_InclusiveHit_OffTheta", "h1_phiGlobalCe_bx", 360,-180.,180);
  h1_phiGlobalCe_bx_InclusiveHit_OnPhi = fs->make<TH1D>("h1_phiGlobalCe_bx_InclusiveHit_OnPhi", "h1_phiGlobalCe_bx", 360,-180.,180);
  h1_phiGlobalCe_bx_InclusiveHit_OffPhi = fs->make<TH1D>("h1_phiGlobalCe_bx_InclusiveHit_OffPhi", "h1_phiGlobalCe_bx", 360,-180.,180);
  h1_phiGlobalCe_bx_oneHit_OnTheta = fs->make<TH1D>("h1_phiGlobalCe_bx_oneHit_OnTheta", "h1_phiGlobalCe_bx", 360,-180.,180);
  h1_phiGlobalCe_bx_oneHit_OffTheta = fs->make<TH1D>("h1_phiGlobalCe_bx_oneHit_OffTheta", "h1_phiGlobalCe_bx", 360,-180.,180);
  ...
  h1_phiGlobalCu_bx_InclusiveHit = fs->make<TH1D>("h1_phiGlobalCu_bx_InclusiveHit", "h1_phiGlobalCu_bx", 360,-180.,180);
  h1_phiGlobalCu_bx_InclusiveHit_OnTheta = fs->make<TH1D>("h1_phiGlobalCu_bx_InclusiveHit_OnTheta", "h1_phiGlobalCu_bx", 360,-180.,180);
  h1_phiGlobalCu_bx_InclusiveHit_OffTheta = fs->make<TH1D>("h1_phiGlobalCu_bx_InclusiveHit_OffTheta", "h1_phiGlobalCu_bx", 360,-180.,180);
  h1_phiGlobalCu_bx_InclusiveHit_OnPhi = fs->make<TH1D>("h1_phiGlobalCu_bx_InclusiveHit_OnPhi", "h1_phiGlobalCu_bx", 360,-180.,180);
  h1_phiGlobalCu_bx_InclusiveHit_OffPhi = fs->make<TH1D>("h1_phiGlobalCu_bx_InclusiveHit_OffPhi", "h1_phiGlobalCu_bx", 360,-180.,180);
  h1_phiGlobalCu_bx_oneHit_OnTheta = fs->make<TH1D>("h1_phiGlobalCu_bx_oneHit_OnTheta", "h1_phiGlobalCu_bx", 360,-180.,180);
  h1_phiGlobalCu_bx_oneHit_OffTheta = fs->make<TH1D>("h1_phiGlobalCu_bx_oneHit_OffTheta", "h1_phiGlobalCu_bx", 360,-180.,180);
  ...
  h2_bx_emu_unpack_bx_InclusiveHit = fs->make<TH2D>("h2_bx_emu_unpack_bx_InclusiveHit", "h2_bx_emu_unpack_bx", 8, -4., 4.,8, -4., 4.);
  h2_bx_emu_unpack_bx_InclusiveHit_OnTheta = fs->make<TH2D>("h2_bx_emu_unpack_bx_InclusiveHit_OnTheta", "h2_bx_emu_unpack_bx", 8, -4., 4.,8, -4., 4.);
  h2_bx_emu_unpack_bx_InclusiveHit_OffTheta = fs->make<TH2D>("h2_bx_emu_unpack_bx_InclusiveHit_OffTheta", "h2_bx_emu_unpack_bx", 8, -4., 4.,8, -4., 4.);
  h2_bx_emu_unpack_bx_InclusiveHit_OnPhi = fs->make<TH2D>("h2_bx_emu_unpack_bx_InclusiveHit_OnPhi", "h2_bx_emu_unpack_bx", 8, -4., 4.,8, -4., 4.);
  h2_bx_emu_unpack_bx_InclusiveHit_OffPhi = fs->make<TH2D>("h2_bx_emu_unpack_bx_InclusiveHit_OffPhi", "h2_bx_emu_unpack_bx", 8, -4., 4.,8, -4., 4.);
  h2_bx_emu_unpack_bx_oneHit_OnTheta = fs->make<TH2D>("h2_bx_emu_unpack_bx_oneHit_OnTheta", "h2_bx_emu_unpack_bx", 8, -4., 4.,8, -4., 4.);
  h2_bx_emu_unpack_bx_oneHit_OffTheta = fs->make<TH2D>("h2_bx_emu_unpack_bx_oneHit_OffTheta", "h2_bx_emu_unpack_bx", 8, -4., 4.,8, -4., 4.);
  ...
  h2_phiInt_emu_unpack_bx_InclusiveHit = fs->make<TH2D>("h2_phiInt_emu_unpack_bx_InclusiveHit", "h2_phiInt_emu_unpack_bx", 124, 0., 1240.,124, 0., 1240.);
  h2_phiInt_emu_unpack_bx_InclusiveHit_OnTheta = fs->make<TH2D>("h2_phiInt_emu_unpack_bx_InclusiveHit_OnTheta", "h2_phiInt_emu_unpack_bx", 124, 0., 1240.,124, 0., 1240.);
  h2_phiInt_emu_unpack_bx_InclusiveHit_OffTheta = fs->make<TH2D>("h2_phiInt_emu_unpack_bx_InclusiveHit_OffTheta", "h2_phiInt_emu_unpack_bx", 124, 0., 1240.,124, 0., 1240.);
  h2_phiInt_emu_unpack_bx_InclusiveHit_OnPhi = fs->make<TH2D>("h2_phiInt_emu_unpack_bx_InclusiveHit_OnPhi", "h2_phiInt_emu_unpack_bx", 124, 0., 1240.,124, 0., 1240.);
  h2_phiInt_emu_unpack_bx_InclusiveHit_OffPhi = fs->make<TH2D>("h2_phiInt_emu_unpack_bx_InclusiveHit_OffPhi", "h2_phiInt_emu_unpack_bx", 124, 0., 1240.,124, 0., 1240.);
  h2_phiInt_emu_unpack_bx_oneHit_OnTheta = fs->make<TH2D>("h2_phiInt_emu_unpack_bx_oneHit_OnTheta", "h2_phiInt_emu_unpack_bx", 124, 0., 1240.,124, 0., 1240.);
  h2_phiInt_emu_unpack_bx_oneHit_OffTheta = fs->make<TH2D>("h2_phiInt_emu_unpack_bx_oneHit_OffTheta", "h2_phiInt_emu_unpack_bx", 124, 0., 1240.,124, 0., 1240.);
  ...
  h2_phiGlobal_emu_unpack_bx_InclusiveHit = fs->make<TH2D>("h2_phiGlobal_emu_unpack_bx_InclusiveHit", "h2_phiGlobal_emu_unpack_bx", 360,-180.,180, 360,-180.,180);
  h2_phiGlobal_emu_unpack_bx_InclusiveHit_OnTheta = fs->make<TH2D>("h2_phiGlobal_emu_unpack_bx_InclusiveHit_OnTheta", "h2_phiGlobal_emu_unpack_bx", 360,-180.,180, 360,-180.,180);
  h2_phiGlobal_emu_unpack_bx_InclusiveHit_OffTheta = fs->make<TH2D>("h2_phiGlobal_emu_unpack_bx_InclusiveHit_OffTheta", "h2_phiGlobal_emu_unpack_bx", 360,-180.,180, 360,-180.,180);
  h2_phiGlobal_emu_unpack_bx_InclusiveHit_OnPhi = fs->make<TH2D>("h2_phiGlobal_emu_unpack_bx_InclusiveHit_OnPhi", "h2_phiGlobal_emu_unpack_bx", 360,-180.,180, 360,-180.,180);
  h2_phiGlobal_emu_unpack_bx_InclusiveHit_OffPhi = fs->make<TH2D>("h2_phiGlobal_emu_unpack_bx_InclusiveHit_OffPhi", "h2_phiGlobal_emu_unpack_bx", 360,-180.,180, 360,-180.,180);
  h2_phiGlobal_emu_unpack_bx_oneHit_OnTheta = fs->make<TH2D>("h2_phiGlobal_emu_unpack_bx_oneHit_OnTheta", "h2_phiGlobal_emu_unpack_bx", 360,-180.,180, 360,-180.,180);
  h2_phiGlobal_emu_unpack_bx_oneHit_OffTheta = fs->make<TH2D>("h2_phiGlobal_emu_unpack_bx_oneHit_OffTheta", "h2_phiGlobal_emu_unpack_bx", 360,-180.,180, 360,-180.,180);
  ...
  h2_thetaInt_emu_unpack_bx_InclusiveHit = fs->make<TH2D>("h2_thetaInt_emu_unpack_bx_InclusiveHit", "h2_thetaInt_emu_unpack_bx", 32, 0., 32., 32, 0., 32.);
  h2_thetaInt_emu_unpack_bx_InclusiveHit_OnTheta = fs->make<TH2D>("h2_thetaInt_emu_unpack_bx_InclusiveHit_OnTheta", "h2_thetaInt_emu_unpack_bx", 32, 0., 32., 32, 0., 32.);
  h2_thetaInt_emu_unpack_bx_InclusiveHit_OffTheta = fs->make<TH2D>("h2_thetaInt_emu_unpack_bx_InclusiveHit_OffTheta", "h2_thetaInt_emu_unpack_bx", 32, 0., 32., 32, 0., 32.);
  h2_thetaInt_emu_unpack_bx_InclusiveHit_OnPhi = fs->make<TH2D>("h2_thetaInt_emu_unpack_bx_InclusiveHit_OnPhi", "h2_thetaInt_emu_unpack_bx", 32, 0., 32., 32, 0., 32.);
  h2_thetaInt_emu_unpack_bx_InclusiveHit_OffPhi = fs->make<TH2D>("h2_thetaInt_emu_unpack_bx_InclusiveHit_OffPhi", "h2_thetaInt_emu_unpack_bx", 32, 0., 32., 32, 0., 32.);
  h2_thetaInt_emu_unpack_bx_oneHit_OnTheta = fs->make<TH2D>("h2_thetaInt_emu_unpack_bx_oneHit_OnTheta", "h2_thetaInt_emu_unpack_bx", 32, 0., 32., 32, 0., 32.);
  h2_thetaInt_emu_unpack_bx_oneHit_OffTheta = fs->make<TH2D>("h2_thetaInt_emu_unpack_bx_oneHit_OffTheta", "h2_thetaInt_emu_unpack_bx", 32, 0., 32., 32, 0., 32.);
  ...
  h2_thetaGlobal_emu_unpack_bx_InclusiveHit = fs->make<TH2D>("h2_thetaGlobal_emu_unpack_bx_InclusiveHit", "h2_thetaGlobal_emu_unpack_bx", 360,-180.,180, 360,-180.,180);
  h2_thetaGlobal_emu_unpack_bx_InclusiveHit_OnTheta = fs->make<TH2D>("h2_thetaGlobal_emu_unpack_bx_InclusiveHit_OnTheta", "h2_thetaGlobal_emu_unpack_bx", 360,-180.,180, 360,-180.,180);
  h2_thetaGlobal_emu_unpack_bx_InclusiveHit_OffTheta = fs->make<TH2D>("h2_thetaGlobal_emu_unpack_bx_InclusiveHit_OffTheta", "h2_thetaGlobal_emu_unpack_bx", 360,-180.,180, 360,-180.,180);
  h2_thetaGlobal_emu_unpack_bx_InclusiveHit_OnPhi = fs->make<TH2D>("h2_thetaGlobal_emu_unpack_bx_InclusiveHit_OnPhi", "h2_thetaGlobal_emu_unpack_bx", 360,-180.,180, 360,-180.,180);
  h2_thetaGlobal_emu_unpack_bx_InclusiveHit_OffPhi = fs->make<TH2D>("h2_thetaGlobal_emu_unpack_bx_InclusiveHit_OffPhi", "h2_thetaGlobal_emu_unpack_bx", 360,-180.,180, 360,-180.,180);
  h2_thetaGlobal_emu_unpack_bx_oneHit_OnTheta = fs->make<TH2D>("h2_thetaGlobal_emu_unpack_bx_oneHit_OnTheta", "h2_thetaGlobal_emu_unpack_bx", 360,-180.,180, 360,-180.,180);
  h2_thetaGlobal_emu_unpack_bx_oneHit_OffTheta = fs->make<TH2D>("h2_thetaGlobal_emu_unpack_bx_oneHit_OffTheta", "h2_thetaGlobal_emu_unpack_bx", 360,-180.,180, 360,-180.,180);
  ...
  h2_chamberID_emu_unpack_bx_InclusiveHit = fs->make<TH2D>("h2_chamberID_emu_unpack_bx_InclusiveHit", "h2_chamberID_emu_unpack_bx", 36, 1, 37, 36, 1, 37);
  h2_chamberID_emu_unpack_bx_InclusiveHit_OnTheta = fs->make<TH2D>("h2_chamberID_emu_unpack_bx_InclusiveHit_OnTheta", "h2_chamberID_emu_unpack_bx", 36, 1, 37, 36, 1, 37);
  h2_chamberID_emu_unpack_bx_InclusiveHit_OffTheta = fs->make<TH2D>("h2_chamberID_emu_unpack_bx_InclusiveHit_OffTheta", "h2_chamberID_emu_unpack_bx", 36, 1, 37, 36, 1, 37);
  h2_chamberID_emu_unpack_bx_InclusiveHit_OnPhi = fs->make<TH2D>("h2_chamberID_emu_unpack_bx_InclusiveHit_OnPhi", "h2_chamberID_emu_unpack_bx", 36, 1, 37, 36, 1, 37);
  h2_chamberID_emu_unpack_bx_InclusiveHit_OffPhi = fs->make<TH2D>("h2_chamberID_emu_unpack_bx_InclusiveHit_OffPhi", "h2_chamberID_emu_unpack_bx", 36, 1, 37, 36, 1, 37);
  h2_chamberID_emu_unpack_bx_oneHit_OnTheta = fs->make<TH2D>("h2_chamberID_emu_unpack_bx_oneHit_OnTheta", "h2_chamberID_emu_unpack_bx", 36, 1, 37, 36, 1, 37);
  h2_chamberID_emu_unpack_bx_oneHit_OffTheta = fs->make<TH2D>("h2_chamberID_emu_unpack_bx_oneHit_OffTheta", "h2_chamberID_emu_unpack_bx", 36, 1, 37, 36, 1, 37);
  ...
  h2_chamberID_vs_roll_emu_bx_InclusiveHit = fs->make<TH2D>("h2_chamberID_vs_roll_emu_bx_InclusiveHit", "h2_chamberID_vs_roll_emu_bx", 36, 1, 37, 4, 0, 4);
  h2_chamberID_vs_roll_emu_bx_InclusiveHit_OnTheta = fs->make<TH2D>("h2_chamberID_vs_roll_emu_bx_InclusiveHit_OnTheta", "h2_chamberID_vs_roll_emu_bx", 36, 1, 37, 4, 0, 4);
  h2_chamberID_vs_roll_emu_bx_InclusiveHit_OffTheta = fs->make<TH2D>("h2_chamberID_vs_roll_emu_bx_InclusiveHit_OffTheta", "h2_chamberID_vs_roll_emu_bx", 36, 1, 37, 4, 0, 4);
  h2_chamberID_vs_roll_emu_bx_InclusiveHit_OnPhi = fs->make<TH2D>("h2_chamberID_vs_roll_emu_bx_InclusiveHit_OnPhi", "h2_chamberID_vs_roll_emu_bx", 36, 1, 37, 4, 0, 4);
  h2_chamberID_vs_roll_emu_bx_InclusiveHit_OffPhi = fs->make<TH2D>("h2_chamberID_vs_roll_emu_bx_InclusiveHit_OffPhi", "h2_chamberID_vs_roll_emu_bx", 36, 1, 37, 4, 0, 4);
  h2_chamberID_vs_roll_emu_bx_oneHit_OnTheta = fs->make<TH2D>("h2_chamberID_vs_roll_emu_bx_oneHit_OnTheta", "h2_chamberID_vs_roll_emu_bx", 36, 1, 37, 4, 0, 4);
  h2_chamberID_vs_roll_emu_bx_oneHit_OffTheta = fs->make<TH2D>("h2_chamberID_vs_roll_emu_bx_oneHit_OffTheta", "h2_chamberID_vs_roll_emu_bx", 36, 1, 37, 4, 0, 4);
  ...
  h2_chamberID_vs_roll_unpack_bx_InclusiveHit = fs->make<TH2D>("h2_chamberID_vs_roll_unpack_bx_InclusiveHit", "h2_chamberID_vs_roll_unpack_bx", 36, 1, 37, 4, 0, 4);
  h2_chamberID_vs_roll_unpack_bx_InclusiveHit_OnTheta = fs->make<TH2D>("h2_chamberID_vs_roll_unpack_bx_InclusiveHit_OnTheta", "h2_chamberID_vs_roll_unpack_bx", 36, 1, 37, 4, 0, 4);
  h2_chamberID_vs_roll_unpack_bx_InclusiveHit_OffTheta = fs->make<TH2D>("h2_chamberID_vs_roll_unpack_bx_InclusiveHit_OffTheta", "h2_chamberID_vs_roll_unpack_bx", 36, 1, 37, 4, 0, 4);
  h2_chamberID_vs_roll_unpack_bx_InclusiveHit_OnPhi = fs->make<TH2D>("h2_chamberID_vs_roll_unpack_bx_InclusiveHit_OnPhi", "h2_chamberID_vs_roll_unpack_bx", 36, 1, 37, 4, 0, 4);
  h2_chamberID_vs_roll_unpack_bx_InclusiveHit_OffPhi = fs->make<TH2D>("h2_chamberID_vs_roll_unpack_bx_InclusiveHit_OffPhi", "h2_chamberID_vs_roll_unpack_bx", 36, 1, 37, 4, 0, 4);
  h2_chamberID_vs_roll_unpack_bx_oneHit_OnTheta = fs->make<TH2D>("h2_chamberID_vs_roll_unpack_bx_oneHit_OnTheta", "h2_chamberID_vs_roll_unpack_bx", 36, 1, 37, 4, 0, 4);
  h2_chamberID_vs_roll_unpack_bx_oneHit_OffTheta = fs->make<TH2D>("h2_chamberID_vs_roll_unpack_bx_oneHit_OffTheta", "h2_chamberID_vs_roll_unpack_bx", 36, 1, 37, 4, 0, 4);
  ...
  h2_occupancy_unpacker_bx_InclusiveHit = fs->make<TH2D>("h2_occupancy_unpacker_bx_InclusiveHit", "h2_occupancy_unpacker_bx", 36, 1, 37, 12, 1, 13);
  h2_occupancy_unpacker_bx_InclusiveHit_OnTheta = fs->make<TH2D>("h2_occupancy_unpacker_bx_InclusiveHit_OnTheta", "h2_occupancy_unpacker_bx", 36, 1, 37, 12, 1, 13);
  h2_occupancy_unpacker_bx_InclusiveHit_OffTheta = fs->make<TH2D>("h2_occupancy_unpacker_bx_InclusiveHit_OffTheta", "h2_occupancy_unpacker_bx", 36, 1, 37, 12, 1, 13);
  h2_occupancy_unpacker_bx_InclusiveHit_OnPhi = fs->make<TH2D>("h2_occupancy_unpacker_bx_InclusiveHit_OnPhi", "h2_occupancy_unpacker_bx", 36, 1, 37, 12, 1, 13);
  h2_occupancy_unpacker_bx_InclusiveHit_OffPhi = fs->make<TH2D>("h2_occupancy_unpacker_bx_InclusiveHit_OffPhi", "h2_occupancy_unpacker_bx", 36, 1, 37, 12, 1, 13);
  h2_occupancy_unpacker_bx_oneHit_OnTheta = fs->make<TH2D>("h2_occupancy_unpacker_bx_oneHit_OnTheta", "h2_occupancy_unpacker_bx", 36, 1, 37, 12, 1, 13);
  h2_occupancy_unpacker_bx_oneHit_OffTheta = fs->make<TH2D>("h2_occupancy_unpacker_bx_oneHit_OffTheta", "h2_occupancy_unpacker_bx", 36, 1, 37, 12, 1, 13);
  ...
  h2_occupancy_emulator_bx_InclusiveHit = fs->make<TH2D>("h2_occupancy_emulator_bx_InclusiveHit", "h2_occupancy_emulator_bx", 36, 1, 37, 12, 1, 13);
  h2_occupancy_emulator_bx_InclusiveHit_OnTheta = fs->make<TH2D>("h2_occupancy_emulator_bx_InclusiveHit_OnTheta", "h2_occupancy_emulator_bx", 36, 1, 37, 12, 1, 13);
  h2_occupancy_emulator_bx_InclusiveHit_OffTheta = fs->make<TH2D>("h2_occupancy_emulator_bx_InclusiveHit_OffTheta", "h2_occupancy_emulator_bx", 36, 1, 37, 12, 1, 13);
  h2_occupancy_emulator_bx_InclusiveHit_OnPhi = fs->make<TH2D>("h2_occupancy_emulator_bx_InclusiveHit_OnPhi", "h2_occupancy_emulator_bx", 36, 1, 37, 12, 1, 13);
  h2_occupancy_emulator_bx_InclusiveHit_OffPhi = fs->make<TH2D>("h2_occupancy_emulator_bx_InclusiveHit_OffPhi", "h2_occupancy_emulator_bx", 36, 1, 37, 12, 1, 13);
  h2_occupancy_emulator_bx_oneHit_OnTheta = fs->make<TH2D>("h2_occupancy_emulator_bx_oneHit_OnTheta", "h2_occupancy_emulator_bx", 36, 1, 37, 12, 1, 13);
  h2_occupancy_emulator_bx_oneHit_OffTheta = fs->make<TH2D>("h2_occupancy_emulator_bx_oneHit_OffTheta", "h2_occupancy_emulator_bx", 36, 1, 37, 12, 1, 13);
