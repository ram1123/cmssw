...
os.system("cp DQM_CPPF-Final15Jan.root plots/")
...
for i in range(0,len(hnames)):
  ...
  if (hnames[i][0]).endswith("_bx"):
     ...
     Table_Histo_Details.append(TH1_histo_details)
     TH1_histo_details = SaveHistos(hnames[i][0]+"_InclusiveHit", hnames[i][1], hnames[i][2], hnames[i][3], " && Matching")
     Table_Histo_Details.append(TH1_histo_details)
     TH1_histo_details = SaveHistos(hnames[i][0]+"_oneHit_OnPhi", hnames[i][1], hnames[i][2], hnames[i][3], " && One Hit && Same #phi")
     Table_Histo_Details.append(TH1_histo_details)
     TH1_histo_details = SaveHistos(hnames[i][0]+"_oneHit_OffPhi", hnames[i][1], hnames[i][2], hnames[i][3], " && One Hit && OffPhi")
     Table_Histo_Details.append(TH1_histo_details)
     TH1_histo_details = SaveHistos(hnames[i][0]+"_oneHit_OnTheta", hnames[i][1], hnames[i][2], hnames[i][3], " && One Hit && Same #theta")
     Table_Histo_Details.append(TH1_histo_details)
     TH1_histo_details = SaveHistos(hnames[i][0]+"_oneHit_OffTheta", hnames[i][1], hnames[i][2], hnames[i][3], " && One Hit && OffTheta")
     Table_Histo_Details.append(TH1_histo_details)
     TH1_histo_details = SaveHistos(hnames[i][0]+"_InclusiveHit_OnPhi", hnames[i][1], hnames[i][2], hnames[i][3], " && Same #phi && Matching")
     Table_Histo_Details.append(TH1_histo_details)
     TH1_histo_details = SaveHistos(hnames[i][0]+"_InclusiveHit_OffPhi", hnames[i][1], hnames[i][2], hnames[i][3], " && OffPhi && Matching")
     Table_Histo_Details.append(TH1_histo_details)
     TH1_histo_details = SaveHistos(hnames[i][0]+"_InclusiveHit_OnTheta", hnames[i][1], hnames[i][2], hnames[i][3], " && Same #theta && Matching")
     Table_Histo_Details.append(TH1_histo_details)
     TH1_histo_details = SaveHistos(hnames[i][0]+"_InclusiveHit_OffTheta", hnames[i][1], hnames[i][2], hnames[i][3], " && OffTheta && Matching")
     Table_Histo_Details.append(TH1_histo_details)
  #
  # thetaCe == thetaCu
  #
...
for i in range(0,len(h2dnames)):
  ...
  if (hnames[i][0]).endswith("_bx"):
     ...
     Table_Histo_Details_Th2.append(TH2_histo_details)
     TH2_histo_details = Save2DHistos(h2dnames[i][0]+"_InclusiveHit", h2dnames[i][2], h2dnames[i][3], h2dnames[i][1], " && Matching")
     Table_Histo_Details_Th2.append(TH2_histo_details)
     TH2_histo_details = Save2DHistos(h2dnames[i][0]+"_oneHit_OnPhi", h2dnames[i][2], h2dnames[i][3], h2dnames[i][1], " && One Hit && Same #phi")
     Table_Histo_Details_Th2.append(TH2_histo_details)
     TH2_histo_details = Save2DHistos(h2dnames[i][0]+"_oneHit_OffPhi", h2dnames[i][2], h2dnames[i][3], h2dnames[i][1], " && One Hit && OffPhi")
     Table_Histo_Details_Th2.append(TH2_histo_details)
     TH2_histo_details = Save2DHistos(h2dnames[i][0]+"_oneHit_OnTheta", h2dnames[i][2], h2dnames[i][3], h2dnames[i][1], " && One Hit && Same #theta")
     Table_Histo_Details_Th2.append(TH2_histo_details)
     TH2_histo_details = Save2DHistos(h2dnames[i][0]+"_oneHit_OffTheta", h2dnames[i][2], h2dnames[i][3], h2dnames[i][1], " && One Hit && OffTheta")
     Table_Histo_Details_Th2.append(TH2_histo_details)
     TH2_histo_details = Save2DHistos(h2dnames[i][0]+"_InclusiveHit_OnPhi", h2dnames[i][2], h2dnames[i][3], h2dnames[i][1], " && Same #phi && Matching")
     Table_Histo_Details_Th2.append(TH2_histo_details)
     TH2_histo_details = Save2DHistos(h2dnames[i][0]+"_InclusiveHit_OffPhi", h2dnames[i][2], h2dnames[i][3], h2dnames[i][1], " && OffPhi && Matching")
     Table_Histo_Details_Th2.append(TH2_histo_details)
     TH2_histo_details = Save2DHistos(h2dnames[i][0]+"_InclusiveHit_OnTheta", h2dnames[i][2], h2dnames[i][3], h2dnames[i][1], " && Same #theta && Matching")
     Table_Histo_Details_Th2.append(TH2_histo_details)
     TH2_histo_details = Save2DHistos(h2dnames[i][0]+"_InclusiveHit_OffTheta", h2dnames[i][2], h2dnames[i][3], h2dnames[i][1], " && OffTheta && Matching")
     Table_Histo_Details_Th2.append(TH2_histo_details)
