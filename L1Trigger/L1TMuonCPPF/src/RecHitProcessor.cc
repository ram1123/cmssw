...
RecHitProcessor::~RecHitProcessor() {
//auto deleter = [](l1t::CPPFDigi*p){
//                delete p;
//               };
//std::shared_ptr<l1t::CPPFDigi> MainVariables1(new l1t::CPPFDigi(), deleter);
//std::shared_ptr<l1t::CPPFDigi> MainVariables2(new l1t::CPPFDigi(), deleter);
}
